...
/***
 * 区块用户
 * 表名（ta_sop_BlockUsers）
 * @author 刘培
 * 
 */
public class BlockUsers implements java.io.Serializable{
	...
	private String addDatatime;// 添加时间
	private Integer blockId;//领取区块id
	private String blockStatus;//领取状态
	private Block block;
