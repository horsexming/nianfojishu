 ...
 * 
 */
public class ProcessInfor implements Comparator , Serializable  {
	...
	private String upprocessName;//上工序名称(页面传值)
	...
	public String getUpprocessName() {
		return upprocessName;
	}

	public void setUpprocessName(String upprocessName) {
		this.upprocessName = upprocessName;
	}
