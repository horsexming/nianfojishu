...
public class PerformsingleDetail  implements java.io.Serializable {
	private static final long serialVersionUID = 1L;
	private Integer id;
	private Float zongMoney;//总金额
	private Performsingle performsingle;//对应执行单
	/*****项目采购*********/
...
//	private String macrepair_alermMan;//报修人
	...
	private Integer quotedPrice_id;//项目核算ID
	private Integer bargain_id;//询比议价ID
	private Integer zhaobiao_id;//招标ID
	private Integer wgww_id;//外购外委ID
	private Integer kvp_id;//kvpID
	...
	public Integer getQuotedPrice_id() {
		return quotedPrice_id;
	}
	public void setQuotedPrice_id(Integer quotedPriceId) {
		quotedPrice_id = quotedPriceId;
	}
	public Integer getBargain_id() {
		return bargain_id;
	}
	public void setBargain_id(Integer bargainId) {
		bargain_id = bargainId;
	}
	public Integer getZhaobiao_id() {
		return zhaobiao_id;
	}
	public void setZhaobiao_id(Integer zhaobiaoId) {
		zhaobiao_id = zhaobiaoId;
	}
	public Integer getWgww_id() {
		return wgww_id;
	}
	public void setWgww_id(Integer wgwwId) {
		wgww_id = wgwwId;
	}
	public Integer getKvp_id() {
		return kvp_id;
	}
	public void setKvp_id(Integer kvpId) {
		kvp_id = kvpId;
	}
