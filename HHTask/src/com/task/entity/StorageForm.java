...
public class StorageForm implements Serializable{
	...
	private String parClass; // 类别
	private String place; // 位置
	private String duizhang; // 对账
	private Float num; // 数量
	private Integer carePeriod; // 维修周期

	private String appDept; // 部门
	private Date date; // 时间
	private String more; // 依据
	/** 入库属性 */
	private String storageInvoice; // 发票号
	private String storageCompany; // 供应商
	private Float storageTaxPrice; // 含税价格
	...
	private String category; // 分类(块\箱)
	private Float conversionNum; // 对应数量
	private Float categoryNum; // 分类的数量
	...
	public Float getConversionNum() {
		return conversionNum;
	}

	public void setConversionNum(Float conversionNum) {
