...
public class ZhaobiaoXis  implements Serializable {
	private static final long serialVersionUID = 1L;
	private Integer id[];
	private Integer t1[];//题目
	private String t2[];//采用模版
	private String t3[];//负责人
	private String t4[]  ;//联系电话
	private String t5[] ;//状态
	private String  t6[];//简介
	private String  t7[];
	private String  t8[];
	private Integer  t9[];
	private Integer  t10[];
