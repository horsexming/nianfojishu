...
public class NianXiuMingxi implements Serializable {
...
//	private Float   kouchu; 		//统一扣除年休
	...
	public Integer getNianxiuId() {
		return nianxiuId;
	}
	public void setNianxiuId(Integer nianxiuId) {
		this.nianxiuId = nianxiuId;
	}
