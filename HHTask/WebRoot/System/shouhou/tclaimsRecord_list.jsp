		...
		<div align="center">
			<table id="mytable" width="100%" border="0" style="border-collapse: collapse;" class="table">
				<tr bgcolor="#c0dcf2" height="50px">
					...
					<th align="center">分析原因</th>
					<th align="center">整改</th>
					<th align="center">整改人</th>
...
<%--								<a href="DownAction.action?fileName=${r.reasonFilename}&amp;directory=/upload/file/tclaimsrecord/">下载</a>--%>
						...
						<td align="center">${r.handle}</td>
						<td align="center">${r.handlePerson}</td>
						<td align="center">
							<s:if test="#r.handleFilename != null ">
<%--								<a href="DownAction.action?fileName=${r.handleFilename}&amp;directory=/upload/file/tclaimsrecord/">下载</a>--%>
								<a href="FileViewAction.action?FilePath=/upload/file/tclaimsrecord/${r.handleFilename}&amp">下载</a>
							</s:if>
						</td>
