...
<html>
		...
		<div id="gongneng"
			...
			<div id="xitong"
				...
				<div style="float: left; width: 45%; padding-top: 5px;"
					align="right">
					<a href="annualLeave!gengxin.action" style="color: #ffffff">刷新</a>
				</div>
			</div>
			
			<div align="center" id="d1">
					<form action="annualLeave!listhuanxiu.action"  method="post"  theme="simple">
				<table class="table">
					<tr>
						...
						<td rowspan="2" align="center">
						  ...
						  <input type="button" value="导出换休" onclick="daochu();todisabledone(this)" data="downData" style="width: 80px; height: 50px;"/>
						  <input type="button" value="导出" onclick="daochu1();todisabledone(this)" data="downData" style="width: 80px; height: 50px;"/>
	...
	function daochu(){
				window.location="annualLeave_daochu.action?tag=huan";
			}
	function daochu1(){
				window.location="annualLeave_daochu.action";
			}
	</SCRIPT>
