			...
			<div align="center">
				<div id="xitong"
					...
					<div style="float: left; width: 45%; padding-top: 5px;"
						align="right">
						<a href="dimissionLogAction_showList_dai.action?tag=tongzhi"
				...
				<div align="center">
					...
					<form action="dimissionLogAction_showList_dai.action?tag=tongzhi" method="post">
					...
					<table  class="table">
						...
						<s:iterator value="dimissionLogList" id="dimisl"
							...
							<td colspan="2">
								...
								<s:if
									test="#dimisl.tongzhi_status!=null&&#dimisl.tongzhi_status=='待填写'&&#dimisl.lzsq_status=='同意'">
									<a
										href="dimission_XieYiAction_toadd.action?dimissionLog.id=${dimisl.id}&tag=notice">/<font
										color="#ff0000">添加离职通知单</font>
									</a>
								</s:if>
							</td>
