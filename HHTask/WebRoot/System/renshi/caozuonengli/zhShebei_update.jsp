	...
	<body>
		...
		<div id="gongneng"
			...
			<div align="center" id="d1">
				<form action="caoZuoAction!updateshebei.action" method="post"
					theme="simple">
					<table>
						<tr>
							<td>
							...
							<td>
							<input type="hidden" value="${zhShebei.id}" name="zhShebei.id">
								<select id="gongweiId" name="zhShebei.gongweiId"
									style="width: 155px;" onchange="f2(this.value)">
									<option value="${zhShebei.gongweiId}">${zhShebei.gongweiId} </option>
									</select>
						...
						<tr>
							...
							<td>
								<select id="shebeiId" name="zhShebei.shebeiId"
									style="width: 155px;" onchange="f3();f4();">
									<option value="${zhShebei.shebeiId}">${zhShebei.shebeiId} </option>
									</select>
							</td>
						</tr>
						<tr>
							...
							<td>
								<select id="zhShebeiname" name="zhShebei.shebeiname"
									style="width: 155px;">
									<option value="${zhShebei.shebeiname}">${zhShebei.shebeiname} </option>
									</select>
							</td>
						</tr>
						<tr>
							...
							<td>
								<select id="shebeigongxuName" name="zhShebei.shebeigongxuName"
									style="width: 155px;">
									<option value="${zhShebei.shebeigongxuName}">${zhShebei.shebeigongxuName} </option>
									</select>
							</td>
						</tr>
