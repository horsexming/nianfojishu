		...
		<div id="gongneng"
			...
			<div id="xitong"
				...
				<div style="float: left; width: 45%; padding-top: 5px;"
					align="right">
					<a href="annualLeave!listhuanxiumingxi.action" style="color: #ffffff">刷新</a>
				</div>
			</div>
...
<%--					</tr>--%>
				...
				<br />
				<s:if test="al==null">
					<h2><font style="color: red">您还没有加班换休的记录</font></h2>
				</s:if>
				<s:else>
					<br />
				</s:else>
				...
				<table class="table">
					<tr>
						<th align="center" colspan="18" style="size: 15px;">
							<font style="size: 12px;">换休记录</font>
						</th>
					</tr>
					...
					<s:if test="listoveT.size()>0">
					<table class="table">
					<tr>
						<th colspan="9">换休加班记录</th>
					</tr>
						<tr bgcolor="#c0dcf2">
						...
						<td align="center">可用换休时长/h</td>
						<td align="center">备注(加工件号)</td>
					</tr>
					<s:iterator value="listoveT" id="pageList" status="pageStatus">
						<s:if test="#pageStatus.index%2==1">
							<tr align="center" bgcolor="#e6f3fb"
								onmouseover="chageBgcolor(this)"
								onmouseout="outBgcolor(this,'#e6f3fb')">
