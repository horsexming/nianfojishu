		...
		<div id="gongneng"
			...
			<div align="center">
				<div align="center" style="color: red; font-size: 16px;">
					<s:if test="wage!=null">
员工${wageStandard.userName}的${wage.mouth}工资,<a
							href="javascript:chageTitle('${wageStandard.userName}','${wage.id}')">明细</a>
						<a href="WageAction!delLeaveWage.action?id=${wage.id}"
				...
				<div>
					...
					<s:if test="wage!=null">
						<form id="leaveWageForm" action="WageAction!updateWage.action"
							...
							<input id="leaveBuchang" name="wage.leaveBuchang" value="0"
								type="hidden" />
							<input type="hidden" name="wage.wageClass" value="处理工资" />
							...
							<input type="hidden" name="wage.fangzufei"
								value="${wage.fangzufei}" />
							<input type="hidden" id="dhbt" name="wage.dianhuabutie"
								value="${wage.dianhuabutie}" />
							<input type="hidden" id="jinenggongzi" name="wage.jinenggongzi"
								value="${wage.jinenggongzi}" />
							<input type="hidden" id="gonglinggongzi"
								name="wage.gonglinggongzi" value="${wage.gonglinggongzi}" />
							<table width="100%" class="table">
								<tr>
									<th align="center" colspan="6">
										<font color="red">${wage.userName}</font> 的${wage.mouth}工资
									</th>
								</tr>
								<tr>
									<th align="right">
					...
					<s:else>
						<form id="leaveWageForm" action="WageAction!addLeaveWage.action"
							...
							<input type="hidden" id="jixiaokaohegongzi" name="wage.fangzufei"
							...
							<table width="100%" class="table">
								<tr>
									<th align="center" colspan="6">
										添加
										<font color="red">${wageStandard.userName}</font> 的工资
									</th>
								</tr>
								<tr>
									<th align="right">
