...
.tooltip {
	...
	<body>
		...
		<%--<div id="topDiv" align="center"
			style="border-bottom: solid 3px #e0dedf; filter: Alpha(Opacity =                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         75); background: #ffffff; opacity: 1; position: absolute; top: 0px; left: 0px; width: 100%; margin: auto;">
			<div
				style="width: 980px; padding-top: 10px; font-size: 12px; height: 30px;"
				align="center">
				<div
					style="float: left; width: 20%; font-size: 14px; padding-left: 20px; border: solid #000000 0px;"
					align="left">
					<a href="ModuleFunctionAction!findMfByUser.action">生产力生态平衡系统</a>
				</div>
				<div
					style="width: 77%; font-size: 14px; float: left; border: solid #000000 0px;"
					align="right">
					欢迎您
					<a href="userCenter/userManage.jsp" style="color: red;">${sessionScope.Users.name}</a>
					<a href="userCenter/userManage.jsp">[个人中心]</a> |
					<img id="pmImg" alt="" src="<%=basePath%>images/newpm.gif"
						style="display: none;">
					<a id="messageCount"
						href="AlertMessagesAction!findAlertMessages.action">消息</a> |

					<a id="nav-add-favorite" href="javascript:;">收藏本站</a> |
					<a href="logOff.jsp" style="color: blue">[退出]</a>
				</div>
			</div>
		</div>
		--%>
