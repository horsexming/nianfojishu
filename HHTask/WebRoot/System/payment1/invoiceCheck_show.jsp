					...
					<s:iterator value="invoiceCheckList" id="toolCabines"
						...
						<td align="center" >
							<s:if test='#toolCabines.baoxiaoStatus=="未报销"'>
								<input type="button"
									style="background-color: green; color: #000; width: 54px; height: 25px;"
									value="${toolCabines.baoxiaoStatus}" />
						</s:if>
							<s:else>
								<input type="button"
									style="background-color: red; color: #fff; width: 54px; height: 25px;"
									value="${toolCabines.baoxiaoStatus}" />
							</s:else>
						</td>
						...
						<td align="left">
							<s:if test="pagestatus!=null && pagestatus=='code'">
