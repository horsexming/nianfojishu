...
body {
	...
	<body onload="convertCurrency(${fundApply.totalMoney})">
		...
		<div id="gongneng">
				...
				<div id="printDiv" align="center" style="width: 100%;">
					...
					<table border="0" style="width: 100%">
						<tr>
							...
							<td align="right" width="30%">
								附件 &nbsp;
								<a href="<%=basePath%>/FileViewAction.action?FilePath=/upload/file/fundApply/<s:property value="fundApply.attachmentsFile"/>"> ${fundApply.attachmentsCount}</a> 
							</td>
							<td align="right">
							<div>
					...
					<table class="table" style="width: 100%">
						...
						<tr height="35px">
							...
							<s:else>
								<th rowspan="<s:property value='fundApply.fadList.size()+1'/>"
									width="5%">
									说明
								</th>
								<th rowspan="<s:property value='fundApply.fadList.size()+1'/>"
						...
						<s:iterator value="fundApply.fadList" status="hk" id="detail">
							<tr align="center" height="35px">
								...
								<td align="right">
									<fmt:formatNumber type="number" value="${detail.voucherMoney}"
						...
						<tr height="35px">
							...
							<th align="left" colspan="2">
								...
								<fmt:formatNumber type="number" value="${fundApply.totalMoney}"
									pattern="0.00" maxFractionDigits="2" />
							</th>
							<th>
								类型
						...
						<tr height="35px">
							...
							<th align="left" colspan="2" id="Result"></th>
							<th>
								${fundApply.about}
							</th>
						</tr>
			...
			<s:if test='fundApply.about=="主营应付"'>
			...
			<s:else>
				<a href="CircuitRunAction_findAduitPage.action?id=${fundApply.epId}">待审批</a>
			</s:else>
			</s:else>
		</div>
...
$(function(){
			getQRCode (80,80,"<%=AlertMessagesServerImpl.pebsUrl%>FundApplyAction_findfundDetailedList.action?id=${id}","showQr");
