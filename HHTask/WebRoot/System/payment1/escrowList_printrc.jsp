	...
	<body>
		...
		<div id="gongneng"
			...
			<div  id="printDiv" style="margin-left: 10%;margin-right: 10%">
				<div align="left">
<%--				<h3>--%>
<%--					&nbsp;&nbsp;${bwtCompany}代上海红湖排气系统<label id="yfLable"></label>月份支付明细表--%>
<%--				</h3>--%>
				</div>
				<div>
					<p><b>尊敬的${bwtCompany}众位领导：</b></p>
				<p><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;根据上海红湖股东会及董事会会议纪要以及上海红湖提供给贵公司的月度费用项目需求，
				基于红湖目前的费用支出以及保证后续经营的正常需要，特此申请贵公司予以批准支付如下款项，请领导给予批准为盼。</b></p>
				</div>
<%--				<div>--%>
...
<%--				</div>--%>
				<table width="100%" border="1" style="border-collapse: collapse;">
					...
					<s:iterator value="list" id="pageescrow" status="pageStatus">
						...
						<td align="center">
							<label class="payMonth"></label>.<label class="payDate"></label>
						</td>
...
<%--									</s:elseif>--%>
				...
				<div style="width: 33%;float: left;"><p>制表人：<p/>
					<s:if
						test="zhiliaoList!=null&&zhiliaoList.size()>0">
						<img
							src="<%=path%><s:property value="zhiliaoList.get(zhiliaoList.size()-1)"/>"
							style="width: 80px; height: 50px" />
					</s:if>
					<s:else>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="4px;">${Users.name}</font>
					</s:else>
				</div>
				<div style="clear: both;"></div>
				<div align="right">${companyInfo.name}&nbsp;&nbsp;&nbsp;<label id="zpYear"></label>年<label id="zpMonth"></label>月<label id="zpdate"></label>日	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
			</div>
			<div align="center">
