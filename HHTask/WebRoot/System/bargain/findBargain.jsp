	...
	<body>
		...
		<div id="gongneng"
			...
			<div align="center">
				...
				<form
					action="bargainAction_findBargain.action?test=<s:property value="test"/>"
					method="post">
					<table class="table">
						<tr>
							<td align="center">
								编号：
								<input type="text" name="bargain.bargain_number" />
							</td>
							<td align="center">
								议价单号：
								<input type="text" name="bargain.bargain_num" />
							</td>
							<td align="center">
								件号：
							...
							<td align="center">
								创建时间：
								<input type="text" class="Wdate" name="bargain.bargain_date"
