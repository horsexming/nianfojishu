...
<html>
	...
	<body>
		...
		<div id="gongneng" style="width: 100%;">
			...
			<div align="center">
					<input type="hidden" name="processShiZhi.id" value="${processShiZhi.id}">
					<table style="width: 980px; border-collapse: collapse;" border="0"
						...
						<tr align="center" bgcolor="#c0dcf2"
							...
							<td align="center">
								...
								<tr bgcolor="green">
									<td colspan="7" style="font-family: 微软雅黑; font-weight: bold;"
										align="center">
										<font color="#ffffff"> 已绑定的工艺复杂系数</font>
									</td>
								</tr>
								<s:if test="cc!=null">
								<tr>
							...
							<td align="center"><s:property value="cc.name"/>
							</td>
							<td align="center"><input type="button" value="取消绑定" onclick="link('${processName}',${cc.id},'no')">
							</td>
							</tr>
								</s:if>
							<s:else>
						...
						<s:iterator id="ccPage" value="list" status="ststusfunction">
							...
							<td align="center"><s:property value="#ccPage.name"/>
							</td >
							<td align="center">
							<input type="button" value="绑定" onclick="link('${processName}',${ccPage.id},'yes')">
							</td>
							</tr>
						</s:iterator>
						<tr>
		...
		function link(processName,ccId,linkStatus){
			var isLink="";
			if(linkStatus=='yes'){
				isLink="您将绑定该工艺负荷系数是否继续？";
			}else{
				isLink="您将取消绑定该工艺负荷系数是否继续？";
			}
		...
		//对中文进行加密
			...
			if(window.confirm(isLink)){
				window.location.href="processShiZhiAction_linkcc.action?processShiZhi.processName="+processName+"&cc.id="+ccId;
			}
		}
		</script>
	</body>
