				...
				<form action="yuanclAndWaigjAction_update.action" method="post"
					...
					<table class="table" id="mytable" >
						...
						<tr id="jianhaoTr">
							...
							<td>
								<input type="text" name="yuanclAndWaigj.markId" id="markId" readonly="readonly"
						...
						<tr>
							...
							<td>
								<s:if test='yuanclAndWaigj.iszyl=="是"'>
									<input type="radio" value="否" name="yuanclAndWaigj.iszyl" />否
									<input type="radio" value="是" name="yuanclAndWaigj.iszyl" checked="checked"/>是
								</s:if>
								<s:else>
						...
						<tr>
							...
							<td>
								<input type="text" name="yuanclAndWaigj.maxkc" id="maxkc" value="${yuanclAndWaigj.maxkc}" />
									库存中允许的最大库存数
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<s:if test="yuanclAndWaigj.sunhaoType == '1'">
									<input type="radio" value="0" name="yuanclAndWaigj.sunhaoType" />百分比
									<input type="radio" value="1" name="yuanclAndWaigj.sunhaoType" checked="checked"/>固定值
								</s:if>
								<s:else>
						...
						<tr>
							...
							<td>
								<input type="text" value="${yuanclAndWaigj.sunhao}" name="yuanclAndWaigj.sunhao" onchange="numyanzheng(this)"/>
							</td>
						</tr>
						<tr>
							<th align="right">
