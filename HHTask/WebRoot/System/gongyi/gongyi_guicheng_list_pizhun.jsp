		...
		<div id="gongneng"
			...
			<div align="center">
				<table class="table" style="text-align: center;">
					...
					<s:iterator id="g" value="gongyiGuichengListForDpz" status="st">
						<s:if test="#st.first">
						<tr bgcolor="green">
							<th colspan="11" align="center">
								<font color="#ffffff"> 待批准记录</font>
							</th>
						</tr>
						</s:if>
					...
					<s:iterator id="g" value="gongyiGuichengListForYpz" status="st">
						<s:if test="#st.first">
						<tr bgcolor="green">
							<th colspan="11" align="center">
								<font color="#ffffff"> 已批准记录</font>
							</th>
						</tr>
						</s:if>
						<s:if test="#st.index%2==1" >
