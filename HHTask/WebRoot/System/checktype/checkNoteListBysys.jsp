				...
				系统异常
					...
					<s:iterator value="checkNoteList" id="list"
						...
						<s:if test="#list.status=='待审批'">
							<td align="center">
								<a href="CheckNoteAction_startHandle.action?id=${list.id}&status=kaishi">开始处理</a>
							</td>
						</s:if>
						<s:elseif test="#list.status=='处理中'">
							<td align="center">
								<a href="CheckNoteAction_startHandle.action?id=${list.id}&status=wancheng">处理完成</a>
							</td>
						</s:elseif>
						<s:else>
							<td align="center">
