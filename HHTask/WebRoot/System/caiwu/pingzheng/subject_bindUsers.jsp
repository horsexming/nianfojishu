...
function showDeptSub() {
	$.ajax( {
		type : 'post',
		url : 'SubjectBudgetAction!findSBRateFroUser.action',
		dataType : 'json',
		cache : true,
		data:{
			id:userId
...
//选中函数
function onCheck(treeId,treeNode,e){
	var subId = e.id;
			$.ajax( {
				type : 'post',
				url : 'SubjectBudgetAction!SubBangUsers.action',
				data : {
					id :userId,
					id2:subId
				},
				traditional: true, //这个设置为true
				dataType : 'json',
				cache : true,
