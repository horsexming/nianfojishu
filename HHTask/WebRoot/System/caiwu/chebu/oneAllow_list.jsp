...
body {
				...
				<table class="table">
					...
					<s:if test="{list.size()>0}">
						<s:iterator value="list" status="se" id="bxd">
							...
							<td>	
							<s:if test='"未审批".equals(#bxd.status) || "打回".equals(#bxd.status)'>
	...
	if (window.confirm('确认要删除该条车补申请记录吗?')) {
		window.location.href = "carAllowAction!deleteOneHistory.action?id="+ id1;
	}
}
