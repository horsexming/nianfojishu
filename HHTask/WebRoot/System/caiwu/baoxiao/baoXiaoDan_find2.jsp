		...
		<div id="gongneng"
			...
			<div id="xitong"
				...
				<div style="float: left; width: 45%; padding-top: 5px;"
					...
					<a href="System/caiwu/baoxiao/baoXiaoDan_save.jsp"
						style="color: #ffffff">添加</a>
				</div>
			</div>

			<div align="center">
				<form action="BaoXiaoDanAction!findBaoXiaoDan2.action?tag=${tag}"
					method="post">
					<table class="table">
						<tr>
							<th>
...
<%--													href="BaoXiaoDanAction!updateXiaoDan.action?id=${id}&tag=${tag}">确认</a>--%>
                                        <a href="javascript:void(0)" id="${id}" onClick="a(${id},'${tag}')">确认/</a>
											</s:if>
										</s:if>
...
function exportExcel(objForm) {
	objForm.action = "BaoXiaoDanAction!exportEXCEL2.action?tag=bxd";
	objForm.submit();
}
	function a(id,tag){
				$.ajax({
					url:'BaoXiaoDanAction!updateXiaoDan2.action',
					dataType: 'json',
					type : 'POST',
					data: {
					id:id,
