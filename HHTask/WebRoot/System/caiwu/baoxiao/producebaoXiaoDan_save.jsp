	...
	<body>
		...
		<div id="gongneng"
			...
			<div align="center">
				...
				<form action=" BaoXiaoDanAction!saveBaoXiaoDan1.action" method="post"
					...
					<table width="85%" class="table" id="complexselectedlist">
						<tbody>
							...
							<tr>
								<th align="center">
									<select name="listDetail[0].goodsStoreMarkId" style="width: 80px;"
								...
								<th align="center">
									...
									<select name="listDetail[0].goodsStoreLot" style="width: 180px;" onchange="selectSubjects1(0)"
										id="subject0" >
									</select>
								</th>
								<th align="center">
									<input type="text" id="count0" name="listDetail[0].goodsStoreCount" readonly="readonly" />
									<input type="hidden" id="count_id0" name="listDetail[0].goodsStoreId" />
								</th>
								<th align="center">
									<input type="text" onKeyUp="hejiJine();comparecount(*)" id="h0"
