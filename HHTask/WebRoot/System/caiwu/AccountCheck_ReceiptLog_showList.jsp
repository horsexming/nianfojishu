                ...
                <form action="ReceiptAction!uploadPayProof.action"
                    ...
                    <table class="table" style="width: 40%" align="center">
                        <tr>
                            ...
                            <th align="left">
                                <input type="text" name="corePayable.fapiaoNum" />
                            </th>
                        </tr>
                        <tr>
                            <th align="right">
...
<div id="gongneng" style="width: 100%; margin-top: 10px;">
    <div align="center">
        ...
        <form action="AccountCheckAction_findReceiptLogListforAccountCheck.action" method="post">
        ...
        <form action="ReceiptAction!weituo.action" method="post"
            ...
            <table class="table">
                ...
                <tr id="tr${pagecoreReceiptLog.id}" align="center" bgcolor="#e6f3fb"
                    onmouseover="chageBgcolor(this)"
                    onmouseout="outBgcolor(this,'#e6f3fb')">
                    </s:if>
                    <s:else>
                <tr id="tr${pagecoreReceiptLog.id}" align="center" onmouseover="chageBgcolor(this)"
                    ...
                    <td>
                        <input type="button" value="选择"
                               ...
                               onclick="selectAcheck('${pagecoreReceiptLog.id}','${pagecoreReceiptLog.applyUserName}'
                                       ,'${pagecoreReceiptLog.applyUserCode}')" />
                ...
                <tr id="tr${pagecoreReceiptLog.id}" align="center" onmouseover="chageBgcolor(this)"
                    ...
                    <td>
                        <s:if test='#pagecoreReceiptLog.fileName==null||#pagecoreReceiptLog.fileName==""||#pagecoreReceiptLog.fileName=="上传文件失败!"'>
                            <a href="javascript:;"
                               onclick="updateFapiao('${pagecoreReceiptLog.id}')">上传付款流水号</a>
                        </s:if>
                        <s:else>
                            <a
                                    href="FileViewAction.action?FilePath=/upload/file/payPz/${pagecoreReceiptLog.fileName}">${pagecoreReceiptLog.fileName}</a>
...
<script type="text/javascript">
    ...
    //选择 传回上级
    function selectAcheck(id,addUserName,addUserCode){
        var tr=$("#tr"+id);
        var payee=($(tr).children('td').eq(3)[0].innerText);
        var summary=($(tr).children('td').eq(4)[0].innerText);
        var allMoney=$(tr).children('td').eq(5)[0].innerText;
        var state=$(tr).children('td').eq(10)[0].innerText;
        parent.$("#rid").val(id);
        parent.$("#accountUnit").val(payee);
        parent.$("#summary").val(summary);
        parent.$("#allMoney").val(allMoney);
        parent.$("#state").val(state);
