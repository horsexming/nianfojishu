...
<div id="bodyDiv" align="center" class="transDiv"
	...
	<div id="gongneng"
		...
		<div align="center">
			<h3>历史电子签名管理</h3>
<%--				<form action="signatureAction_findHistorySignature.action?test=<s:property value="test"/>" method="post" >--%>
<%--				<table class="table" >--%>
<%--					<tr>--%>
...
<%--					<a href="DownAction.action?fileName=${pageList.signature_address}&directory=${pageList.signature_address}">下载</a>--%>
							<a href="signatureAction_delSignature.action?del_id=${pageList.id}&test=<s:property value="test"/>">删除</a>
					</td>
				</s:iterator>
				</tr>
				<tr>
	...
	function add() {
		var url = "<%=request.getContextPath()%>/System/signature/addSignature.jsp";
