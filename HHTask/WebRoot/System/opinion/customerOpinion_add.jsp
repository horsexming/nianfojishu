		...
		<div align="center">
			<form action="customerOpinionAction_add.action" method="post" onsubmit="return validate()">
				<table class="table">
					...
					<tr>
						<th>对方负责人</th>
						<td> <input name="customerOpinion.otherPerson" id="otherPerson" /> </td>
						<th>对方联系电话</th>
						<td> <input name="customerOpinion.otherPhone" id="otherPhone"/> </td>
						<th> 对方单位</th>
						<td> <input name="customerOpinion.otherCompany" id="otherCompany"/> </td>
					</tr>
					<tr>
						<th>投诉标题
					 </th>
					 <td> <input name="customerOpinion.title" id="title"/> </td>
						<th>已方负责人</th>
						<td> <input name="customerOpinion.ourPerson" id="ourPerson" /> </td>
						<th>登记时间</th>
						<td> <input name="customerOpinion.addTime" id="addTime" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',skin:'whyGreen'})"/> </td>
					</tr>
					
					<tr>
					<th>投诉内容
					 </th>
					 <td colspan="3"><textarea rows="4" cols="100" name="customerOpinion.context" id="context"></textarea>
					 </td>
					<th>
					 </th>
					 <td> </td>
