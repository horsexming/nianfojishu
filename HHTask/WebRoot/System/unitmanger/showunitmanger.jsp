...
<div id="bodyDiv" align="center" class="transDiv"
		...
		<div id="contentDiv"
			...
			<div id="closeDiv"
				...
				<table style="width: 100%">
					<tr>
						<td>
							<span id="title">您正在对单位管理进行操作</span>
						</td>
						<td align="right">
	...
	<div id="gongneng" align="center">
		...
		<div align="center">
			<h3>单位管理</h3>
				<form action="UnitManagerAction_findUnitManager.action" method="post">
				<table class="table" >
					<tr>
					<th>单位名称</th>
						<td align="left"> 
			...
			<table  class="table">
				...
				<s:iterator value="maps" id="cusList" status="pageStatus">
					...
					<a href="UnitManagerAction_delUnitManager.action?manager.id=${cusList.id}" 	
	...
	function add() {
		var url=encodeURI(encodeURI("${pageContext.request.contextPath}/System/unitmanger/addunitmanger.jsp"));
