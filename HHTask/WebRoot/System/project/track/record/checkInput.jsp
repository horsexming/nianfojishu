...
<html>
	...
	<body>
		...
		<div id="gongneng"
			...
			<div align="center">
				<form action="ProjectTrackRecord_checked.action" method="post">
					...
					<table class="table" style="width: 53%">
						...
						<tr>
							...
							<td>
								<input type="radio" name="p.agree" value="true" checked="checked" />同意
								<input type="radio" name="p.agree" value="false" />不同意
							</td>
							<th align="right">批准钱数:</th>
							<td>
								<input name="p.approveMoney" />
							</td>
						</tr>
						<tr>
							<th align="right">
							...
							<td colspan="3">
								<textarea name="p.about" rows="5" cols="30"></textarea>
							</td>
						</tr>
						<tr>
