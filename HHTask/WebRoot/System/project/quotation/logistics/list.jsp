		...
		<div id="gongneng"
			...
			<div align="center">
				<table class="table" width="100%" border="0" style="border-collapse: collapse;">
					...
					<s:iterator value="logisticses" id="r" status="st">
						...
						<s:else>
							...
							<td>${r.transportationPrice}</td>
							<td>
								<a href="ProjectQuotationLogistics_updateInput.action?logistics.id=${r.id}">修改</a>
		...
		<script type="text/javascript">
			function deleteById(id){
				if(confirm('是否删除?')){
					$.ajax({
						type: "POST",
						url: "ProjectQuotationLogistics_delete.action",
						data: "logistics.id=" + id,
