...
<html>
	...
	<body>
		...
		<div id="gongneng" style="width: 100%;">
			<div align="center">
				<h3>
				        添加项目材料清单<br/>(add project material order)
				</h3>
				<form action="projectMaterialOrderAction_add.action"
					...
					<table id="addTable" width="100%" border="1" style="border-collapse: collapse;">
						...
						<tr id="materialtr0">
						   <td align="center">
								<input name="pmList[0].markId" value="<s:property value="pmList[0].markId"/>">
							</td>
							<td align="center">
								<input name="pmList[0].materialName" value="<s:property value="pmList[0].materialName"/>">
							</td>
							<td align="center">
								<input name="pmList[0].paihao" value="<s:property value="pmList[0].paihao"/>">
							</td>
							<td align="center">
								<input name="pmList[0].guige" value="<s:property value="pmList[0].guige"/>">
							</td>
							<td align="center">
								<input id="needNumber0" name="pmList[0].needNumber" value="<s:property value="pmList[0].needNumber"/>"
								onkeyup="chekNum(0)">
							</td>
							<td align="center">
								<input name="pmList[0].unit" value="<s:property value="pmList[0].unit"/>">
							</td>
							<td align="center">
								<input name="pmList[0].supplier" value="<s:property value="pmList[0].supplier"/>">
							</td>
							<td align="center">
								<input type="button" value="删除材料"  onclick="deleteMaterial(0)"> 
							</td>
						</tr>
						</s:else>
						<tr>
		...
		if(size>0){
		 ...
		 function addMaterial(){
			 ...
			 "/tr>"
			 $("#addTable>tbody>tr").eq(2+listTrSiz).after(html);
			 listTrSiz++;
		 }
