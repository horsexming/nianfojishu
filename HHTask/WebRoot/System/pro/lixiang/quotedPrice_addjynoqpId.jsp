...
<html>
	...
	<body>
		...
		<div id="gongneng" style="width: 100%;">
			<div align="center">
			<h3>添加进度纪要</h3>
				<form action="QuotedPrice_importjy.action" method="post"
					  enctype="multipart/form-data" onsubmit="return checktype()">
					<a href="./upload/file/download/hyjyTemplate.xls">导入模版下载</a>
					<a href="FileViewAction.action?FilePath=/upload/file/download/hyjyTemplate.xls&Refresh=true">/预览</a>
				...
				<form action="QuotedPrice_addjynoqpId.action" method="post" onsubmit="return valedata();">
					<table class="table">
						<tr>
