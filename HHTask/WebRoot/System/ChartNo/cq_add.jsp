	...
	<body>
		...
		<div id="gongneng" style="width: 100%;">
			<div align="center">
				...
				<form action="ChartNOSQAction_pladdcq.action" method="post" onsubmit="">
					<table class="table" id = "mytable">
						<tr>
							...
							<td>
								...
								<ul class="list">
									<li class="title">
										<input id="wgType0" type="text" name="cqList[0].type"  
											style="width: 120px;"  />
											<input id="categoryId0" type="hidden" value="" name="cqList[0].categoryId" onchange="getfirstNo('0')"/>
										<a id="menuBtn" href="#" onclick="showMenu('0'); return false;">选择</a>
									</li>
								</ul>
							</div>
							...
							<td>
								<select id="gztypename0" 
										name="cqList[0].gztype" style="width: 150px"
										 onkeyup="getfirstNo('0')" onblur="getfirstNo('0')">
											<option value=""></option>
										<s:iterator value="cgtList" id="cgt">
											<option value="${cgt.type}">${cgt.type}-${cgt.groups}</option>
										</s:iterator>
								</select>
							</td>
							<th align="right">
							...
							<td>
								<input type="text" value="" id="sqNum0" name="cqList[0].sqNum" onkeyup="numyanzheng(this,'zhengshu');getfirstNo('0')" onblur="numyanzheng(this,'zhengshu');getfirstNo('0')"/>
							</td>
							<td rowspan="3">
								<input type="button" value="追加" onclick="add()" class="input"/>
								<input type="button" value="删除" onclick="del()" class="input"/>
							</td>
						</tr>
						<tr>
							<th align="right">
							...
							<td>
								<input type="text" value="" id="firstNo0" name="" />
								<input type="hidden" value="" id="firstNoValue0" name="cqList[0].firstNo" />
							</td>
							<th align="right">
								到
							<td>
								<input type="text" value="" id="endNo0"  />
								<input type="hidden" value="" id="endNoValue0" name="cqList[0].endNo" />
							</td>
							<th align="right">
								<span id="spanziti_0">
									<s:if test="status == 'fl'">
							...
							<td>
								<input type="text" value="" id="cpcode0" name="cqList[0].cpcode" />
							</td>
						</tr>
						<tr>
							<th align="right">
							...
							<td colspan="5">
								<textarea rows="" cols="100" name="cqList[0].remak"></textarea>
							</td>
						</tr>
					</table>
					<input type="hidden" value="${param.status}" name="status"/>
						<input type="submit" value="申请" onclick="todisabled(this)" class="input"/>
				</form>
			</div>
		</div>
...
function add(){
	...
	'<option value="${cgt.type}">${cgt.type}-${cgt.groups}</option> </s:iterator> </select></td><th align="right">申请数量</th>' +
	...
	'<th align="right"><span id="spanziti_'+count+'">'+leibie+'</span></th><td><input type="text" value="" id="cpcode'+count+'" name="cqList['+count+'].cpcode" /></td></tr>' +
