...
<html>
	...
	<center>
		<table class="table" style="width: 50%;">
				...
				<br />
				<br />
				<form action="zhaobiaoAction!updatezhaobiaoXidahui.action" method="post"
					theme="simple">
					<table class="table" style="width:65%;" >
					
						<tr><th align="right">部门：</th>
							<td>
								<select id="dept" style="width: 90px;"
						...
						<tr><th align="right">模板：</th><td>
									...
									<select id="t9" style="width: 90px;"name="zhaobiaoXi.t9"></select>
								</td></tr>
						<tr><th align="right">数量：</th><td>
						
									<input type="text" name="zhaobiaoXi.t2" id="t2"
									style="width: 80px;"  value="${zhaobiaoXi.t2}"/>
								</td></tr>
						<tr><th align="right">单位：</th><td>
								<SELECT name="zhaobiaoXi.t3" style="width: 40px">
						...
						<tr><th align="right">规格要求：</th><td>
							<input type="text" id="zhaobiaoXi.t5" name="zhaobiaoXi.t5" value="${zhaobiaoXi.t5}" style="width: 250px; height: 50px" >
							</td></tr>
						<tr><th align="right">物料介绍</th><td>
								<input type="text" id="zhaobiaoXi.t6" name="zhaobiaoXi.t6" value="${zhaobiaoXi.t6}" style="width: 250px; height: 50px" >
							<input type="hidden" id="zhaobiaoXi.id" value="${zhaobiaoXi.id}" name="zhaobiaoXi.id" >
