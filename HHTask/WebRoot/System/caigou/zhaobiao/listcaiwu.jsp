				...
				<table class="table">
					...
					<s:iterator value="list" id="zhaobiao" status="pageIndex">
						<tr>
							...
							<th>
							<s:if test='#zhaobiao.status=="F"'>回款方式拟定中</s:if>
							<s:if test='#zhaobiao.status=="G"'>回款方式拟定中</s:if>
							</th>
							<th>
							  <a href="zhaobiaoAction!listcaiwutotoubiao.action?zhaobiao.id=${zhaobiao.id}">查看详细</a>
							 <!--   <a href="zhaobiaoAction!tijiaohuikuangjieguo.action?zhaobiao.id=${zhaobiao.id}">提交回款方式结果</a> -->
							</th>
						</tr>
					</s:iterator>
