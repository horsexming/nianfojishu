...
<html>
	...
	<div id="bodyDiv" align="center" class="transDiv"
		...
		<div id="gongneng"
			...
			<input type="button" value="添加"    class="input" onclick="add()"/></td>	
				</tr>
							<tr  bgcolor="#c0dcf2">
							<th>序号</th>
							<th>年份</th>
...
<script type="text/javascript">
	function add(){
			var url=encodeURI(encodeURI("${pageContext.request.contextPath}/System/caigou/zhaobiao/nianlilv_add.jsp"));
