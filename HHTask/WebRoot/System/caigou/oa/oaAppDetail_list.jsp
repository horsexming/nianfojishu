						...
						<tr>
							...
							<th>
								<select name="oadetail.detailStatus" style="width: 130px;"
									...
									<s:if test="oadetail.detailStatus!=null">
										<option selected="selected" value="${oadetail.detailStatus}">
							...
							<th>
								<select name="oadetail.detailChildClass" style="width: 130px;"
									...
									<s:if test="oadetail.detailChildClass!=null">
										<option selected="selected" value="${oadetail.detailChildClass}">
						...
						<table class="table">
							...
							<s:if test="list.size()>0">
								<s:iterator value="list" status="se" id="detail">
									...
									<td>
										<s:if
											test='"预申请".equals(#detail.detailStatus) || "打回".equals(#detail.detailStatus)'>
											<a href="oaAppDetailAction!getOADetailById.action?id=${id}&tag=update&cpage=${cpage}">修改</a>
											<br />
											<a onClick="return confirm('确定要删除该条记录吗？')"
												href="oaAppDetailAction!deleteOADetailById.action?id=${id}&cpage=${cpage}&powerTag=${powerTag}">删除</a>
											<br />
										</s:if>
