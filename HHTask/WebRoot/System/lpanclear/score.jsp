...
<html>
  ...
  <body style="background-color:#97BCE4;">
      ...
      <p height=6%><a href="ClearInfoAction_userOperation.action"><img src="<%=basePath%>/images/lpanclear/fhsyyl.png" height=6% width=9% title="返回上一页" alt="返回上一页"/></a></p>
      <p height=6%></p>
      ...
      <form action="ClearInfoAction_evaluatorOperation.action" method="POST" enctype="multipart/form-data" onsubmit="return pfdate()">     
          ...
          <table border="0" height=66% width=99% style="border-color:#CCFF99;font-size:22px;margin-top:25px;border-color: #9370DB;color:#9932CC;text-align: center;">
              ...
              <tr height=7%>
                  <th colspan="8">                    
                      <a href="javascript:void(0)"><img id="xlxs" src="<%=basePath%>/images/lpanclear/xll3.png" height=13% width=13% alt="下拉上传图片" title="下拉关闭"></a>
                  </th>  
              </tr>
          </table>
          <!-- 此处为上传图片 -->
