...
<html>
	...
	<body>
		...
		<div id="gongneng"
			...
			<div align="center">
				...
				<form action="singleCarAction_updateExamListB.action" method="post">
					<table class="table">
						<tr>
	...
	<script type="text/javascript">
    	function chageType(obj,form){
    		if(obj.id=="ok"){
    			form.action="singleCarAction_updateExamListB.action?tag=ok";
    			form.submit();
    		}else if (obj.id=="ng"){
    			form.action="singleCarAction_updateExamListB.action?tag=ng";
    			form.submit();
    		}
    	}
