...
<html>
	...
	<body onload="createDept('dept')">
		...
		<div id="gongneng" style="width: 100%;">
			<div align="center">
				<h2>赠送红心</h2>
	<font>您还剩余${param.totalIntegral}红心,最多可赠送${param.totalIntegral}红心</font>
				<form action="IntegralGiftAction_Giveintegral.action" method="post" onsubmit="check()">
					<table>
						<tr>
							<th align="right">
								部门:
						...
						<tr>
							...
							<td>
								...
								<input type="hidden" name="integral.integralName" id="userName"
									value="" />
									<input type="hidden" id="userId" value="" name="integral.userId">
						...
						<tr>
							...
							<td>
								<input type="text" value="" name="integral.isList[0].addintegral"  id="addintegral"
								 onkeyup="numyanzheng(this)" onblur="numyanzheng()" onchange="bijiao(this)"/>
							</td>
						</tr>
						<tr>
							<td colspan="2" align="center">
								<input type="submit" value="赠送" id="sub" class="input" />
							</td>
						</tr>
					</table>
				</form>
