...
<html>
	...
	<body>
		...
		<div id="gongneng" style="width: 100%;">
			<div align="center">
				<h3>修改企业会员基本资料</h3>
				<font color="red" id="fontzi">${errorMessage}</font><br/>
			<form action="CompanyVIPAction_updateComanyVIP.action" method="post"  enctype="multipart/form-data">
				<table  id="table1" style="display: block;">
					...
					<tr>
						...
						<td>
							<input type="text" value="${companvip.typexz}" name="companvip.typexz"
							onfocus="nameyanzhe('typexz','请输入企业性质')" onkeyup="nameyanzhe('typexz','请输入企业性质')"
									onblur="nameyanzhe('typexz','请输入企业性质')"/>
					...
					<tr>
						...
						<td>
							<input type="text" name="companvip.industry" id="industry" value="${companvip.industry}" 
							onfocus="nameyanzhe('industry','请输入所属行业')" onkeyup="nameyanzhe('industry','请输入所属行业')"
									onblur="nameyanzhe('industry','请输入所属行业')"/>
					...
					<tr>
						...
						<td>
							<input type="text" name="companvip.foundingTime"  value="${companvip.foundingTime}"
					...
					<tr>
						...
						<td >
							<input type="text" name="companvip.number"  value="${companvip.number}"
					...
					<tr>
						...
						<td>
							<input type="text" name="companvip.website"  value="${companvip.website}"
					...
					<tr>
						...
						<td>
							<input type="text" name="companvip.address"  value="${companvip.address}"
					...
					<tr>
						...
						<td>
							<input type="text"  id="email" name="companvip.email" value="${companvip.email}"  onkeyup="Emailyanzhen('email','请输入正确的邮箱格式')"
					...
					<tr>
						...
						<td>
							<input type="text" name="companvip.zipcode" value="${companvip.zipcode}" onfocus="nameyanzhe('zipcode','请输入企业邮编')" onkeyup="nameyanzhe('zipcode','请输入企业邮编')"
					...
					<tr>
						...
						<td>
							<input type="text" name="companvip.enumber" onfocus="numyanzhen('enumber','请输入员工人数')" onkeyup="numyanzhen('enumber','请输入员工人数')"
									onblur="numyanzhen('enumber','请输入员工人数')"  value="${companvip.enumber}"
					...
					<tr>
						...
						<td>
							<input type="text" name="companvip.rcapital" onfocus="numyanzhen('rcapital','请输入注册资金')" onkeyup="nameyanzhe('rcapital','请输入注册资金')"
									onblur="numyanzhen('rcapital','请输入注册资金')" value="${companvip.rcapital}"
					...
					<tr>
						...
						<td>
							<input type="text" name="companvip.lastsales"onfocus="numyanzhen('lastsales','请输入去年营业总额')" onkeyup="numyanzhen('lastsales','请输入去年营业总额')"
									onblur="numyanzhen('lastsales','请输入去年营业总额')" onclick="numyanzhen(this)"  value="${companvip.lastsales}"
							 id="lastsales" />(万元)
					...
					<tr>
						...
						<td>
							<input type="text" name="companvip.sales" onfocus="numyanzhen('sales','请输入资产总额')" onkeyup="numyanzhen('sales','请输入资产总额')"
									onblur="numyanzhen('sales','请输入资产总额')" value="${companvip.sales}"
							id="sales" />(万元)
					...
					<tr>
						...
						<td>
							<input type="text" name="companvip.totaltax" onfocus="numyanzhen('totaltax','请输入缴税总额')" onkeyup="numyanzhen('totaltax','请输入缴税总额')"
									onblur="numyanzhen('totaltax','请输入缴税总额')"  value="${companvip.totaltax}"
							 id="totaltax" />(万元)
				...
				<table  id="table2" style="display: none;">
					...
					<tr>
						...
						<td>
							<input type="text"  id="cname" value="${companvip.companyboss.name}" readonly="readonly"/>
						</td>
					</tr>
					<tr>
						<th align="right">
						...
						<td>
							<input type="text"  id="mobilephone" value="${companvip.companyboss.mobilephone}" readonly="readonly"/>
						</td>
					</tr>
					<tr>
						<th align="right">
						...
						<td>
							<s:if test="companvip.companyboss.sex=='男'">
							...
							<s:else>
								<input type="radio" name="companvip.companyboss.sex"  value="男" />男
								<input type="radio" name="companvip.companyboss.sex"  value ="女" checked="checked"/>女
							</s:else>
					...
					<tr>
						...
						<td>
							<input type="text" name="companvip.companyboss.address" value="${companvip.companyboss.address}"
					...
					<tr>
						...
						<td>
							<input type="text" name="companvip.companyboss.post" onfocus="nameyanzhe('post','请输入职务')" onkeyup="nameyanzhe('post','请输入职务')"
									onblur="nameyanzhe('post','请输入职务')" value="${companvip.companyboss.post}"
					...
					<tr>
						...
						<td>
							<input type="text" name="companvip.companyboss.age" onfocus="numyanzhen1('age','请输入年龄')" onkeyup="numyanzhen1('age','请输入年龄')"
									onblur="numyanzhen1('age','请输入年龄')" value="${companvip.companyboss.age}"
							 id="age" maxlength="3" />
					...
					<tr>
						...
						<td>
							<input type="text" name="companvip.companyboss.nation" id="nation" value="${companvip.companyboss.nation}"/>
						</td>
					</tr>
					<tr>
						<th align="right">
						...
						<td>
							<input type="text" name="companvip.companyboss.politicalstatus" 
							value="${companvip.companyboss.politicalstatus}" id="politicalstatus"/>
						</td>
					</tr>
					<tr>
						<th align="right">
						...
						<td>
							<input type="text" name="companvip.companyboss.education" 
							value="${companvip.companyboss.education}" id="education"/>
						</td>
					</tr>
					<tr>
						<th align="right">
						...
						<td>
							<input type="text" name="companvip.companyboss.phoneNum" 
							value="${companvip.companyboss.phoneNum}"	id="phoneNum"/>
						</td>
					</tr>
					<tr>
						<th align="right">
						...
						<td>
							<input type="text" name="companvip.companyboss.email" id="cemail" onkeyup="Emailyanzhen('cemail','请输入正确的邮箱格式')"
							 onblur="Emailyanzhen('cemail','请输入正确的邮箱格式')" 
							 value="${companvip.companyboss.email}"	onfocus="Emailyanzhen('cemail','请输入正确的邮箱格式')"/>
		...
		<div align="left">
			<span>
					<STRONG>
							...
							2、带<font color="red">*</font>为必填项。<br/>
							3、请附企业工商营业执照副本、税务登记有关证件和个人身份证等扫描件。<br/>
						</STRONG>
					</span>
			</div>
			</div>
...
function check(){
	...
	if(cname!=null && cname.value == ""){
		$("#fontzi").html("请填写企业负责人姓名");
		cname.focus();
		return false;
	}else if(sex!=null && sex.value == ""){
		$("#fontzi").html("请填写企业负责人姓别");
		sex.focus();
		return false;
	}else if(address!=null && address.value == ""){
