	...
	<body onload="createDept('dept')">
		...
		<div id="gongneng" style="width: 100%;">
			<div align="center">
				...
				<form action="IntegralAction_addIntegral.action" method="post" onsubmit="return check()">
					<table class="table">
						<tr>
							<th align="right">
								部门:
						...
						<tr>
							...
							<td>
								<input type="text" name="integral.isList[0].addintegral" id="addintegral"/>
							</td>
						</tr>
						<tr>
							<th align="right">
						...
						<tr>
							<td colspan="2" align="center">	
								...
								<input type="submit" value="添加" style="width: 70px;height: 30px;" id="sub" >
							</td>
					</tr>
					</table>
				</form>
