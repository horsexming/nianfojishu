					...
					<table class="table">
						...
						<tr>
							<th colspan="10" align="left" style="border: hidden;">
								...
								<s:elseif test='printedOutOrder.type == "生产领料单" || printedOutOrder.type == "其他出库单"'>
									&nbsp;&nbsp;&nbsp;&nbsp;领料用途:
									<input type="text" value="${printedOutOrder.llyt}" name="poor.llyt" />
								</s:elseif>
							</th>
							<th colspan="3" align="left" style="border: hidden;">
								&nbsp;&nbsp;&nbsp;&nbsp;编&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号:
						...
						<tr>
							...
							<s:elseif test='printedOutOrder.type == "生产领料单" || printedOutOrder.type == "其他出库单"'>
									<th colspan="10" align="left" style="">
										&nbsp;&nbsp;&nbsp;&nbsp;领料部门:
									<input type="text" value="${printedOutOrder.lldept}" name="poor.lldept" />
								</th>
							</s:elseif>
						...
						<s:iterator value="list1" id="pageList" status="statusSdf">
							<tr>
								...
								<th>
									${pageList.banbenNum}
									<input type="hidden" value="${pageList.banbenNum}"
										name="poor.printedOutList[${statusSdf.index}].banbenNum" />
								</th>
								<th>
									${pageList.unit}
