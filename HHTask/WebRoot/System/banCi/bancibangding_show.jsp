		...
		<div id="gongneng" style="width: 100%;">
			<div align="center">
				<div>
					<div>
						给
						<font color="red"> ${banCi.name} </font>绑定
						<s:if test="tag=='dept'">
							本部门
						</s:if>
						人员
					</div>
					<form action="banCiAction_findUserById.action?tag=${tag}" method="post"
						style="margin: 0px">
						<br>
						<table class="table">
							<tr>
					...
					<form action="banCiAction_bangding.action?tag=${tag}" method="post"
						style="margin: 0px">
						<input type="hidden" name="banCi.id" value="${banCi.id}">
						<table class="table" align="center">
							...
							<s:iterator id="users" value="usersList" status="ststusfunction">
