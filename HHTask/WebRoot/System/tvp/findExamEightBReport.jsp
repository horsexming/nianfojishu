...
<html>
	...
	<body>
		...
		<div id="gongneng"
			...
			<div align="center">
				...
				<form action="kvpAssessAction_updateExamKVP.action" method="post">
					<table class="table">
						<tr>
	...
	<script type="text/javascript">
    	function chageType(obj,form){
    		if(obj.id=="ok"){
    			form.action="kvpAssessAction_updateExamEightBReport.action?tag=ok";
    			form.submit();
    		}else if (obj.id=="ng"){
    			form.action="kvpAssessAction_updateExamEightBReport.action?tag=ng";
    			form.submit();
    		}
    	}
