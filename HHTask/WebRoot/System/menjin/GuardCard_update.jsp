	...
	<body>
		...
		<div id="gongneng" style="width: 100%; margin-top: 10px;">
			...
			<div align="center">
				...
				<form action="GuardCardAction_updateGuardCard.action" method="post"
					 onsubmit="return validate()">
					<table class="table">
						<tr style="width: 100%">
							<th align="right" style="width: 300px;">
								工号
								<input type="hidden" name="guardCard.id"
									value="${guardCard.id}" />
							</th>
							<td align="left">
								<input type="text" name="guardCard.code" id="code" 
								value="${guardCard.code}"/>
							</td>
							<th align="right">
								姓名
							</th>
						...
						<tr>
							...
							<td align="left">
								<input type="text" name="guardCard.cardId"
									id="cardId" value="${guardCard.cardId}"/>
							</td>
						...
						<tr>
							...
							<td align="left">
								<input type="text" name="guardCard.birthplace"
									id="birthplace" value="${guardCard.birthplace}"/>
							</td>
							<th align="right">
								身份证
							</th>
