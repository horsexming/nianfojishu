	...
	$("#tablebod>tbody>tr")
			...
			.after(
					"<tr id='addtr"
							...
							+ "].cqType' id="
							+ cqType
							+ "><option value=''>请选择存取档类型</option><option value = '存档'>存档</option><option value = '取档'>取档</option></select></td><th >档案名称</th><td align='center'><input type='text' title='点击选择档案' readonly='readonly' onclick='selectPrice("
							+ index
