				...
				<form action="WarehouseAreaAction_addwarehouseNumber.action"
					...
					<table class="table" id="mytable">
						...
						<tr>
							...
							<th align="left">
								<select name="wnList[0].fourlightIp" id="fourlightIp0">
									<option></option>
								</select>
							</th>
							<th align="right">
...
function addline(){
	...
	'<th align="right">四色灯IP:</th>' +
	'<th align="left"><select name="wnList['+index+'].fourlightIp" id="fourlightIp'+index+'"><option></option></select></th>' +
