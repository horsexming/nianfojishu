...
<%--									<input type="file" id="pic" name="machine.picF" onchange="validateFile();"/>--%>
					...
					<br/>
					<h2 style="font-size: 20px;">保养记录</h2>
					<table class="table" id="bybz_table">
						...
						<s:iterator value="byRecordList" id="bybz" status="pagestatus">
							<tr align="center">
								<td>
								${pagestatus.index+1}
								</td>
					...
					<input type="button"  value="添加保养记录"
									style="width: 100px; height: 50px;" onclick="window.location.href='ProdEquipmentAction!toaddbyr.action?id=${machine.id}&cpage=${cpage}'">
<%--				</form>--%>
			</div>
			<br>
		</div>
