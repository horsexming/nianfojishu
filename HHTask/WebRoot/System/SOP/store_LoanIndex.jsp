			...
			<div align="center">
				...
				<form action="store_queryLoanByCondition.action" method="post">
					<table>
						<tr>
							...
							<td>
								<input type="hidden" name="vos.formUrl" value="store_LoanIndex" />
				...
				<table class="table">
					...
					<s:iterator value="list" id="pageList" status="pageStatus">
						...
						<Td>
							<a
								href="store_initBorrowOrConsuming.action?id=${pageList.id}&vos.formUrl=loan">出借</a>
						</Td>
						</tr>
					</s:iterator>
					<tr>
