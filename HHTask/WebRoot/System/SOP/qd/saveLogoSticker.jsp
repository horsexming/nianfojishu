		...
		<div id="gongneng"
			...
			<div align="center">
				<form action="LogoStickerAction!saveLogoSticker.action" onsubmit="return checkForm()" method="post">
					...
					<table>
						<tr align="center">
						<td colspan="4" style="font-size: 20px;">标识类别：
						<select id="markSelect" style="font-size: 20px;width:150px;" onchange="selectStickStyle(this)" name="sticker.stickStyle">
						<option value="首检样品">首检样品</option>
						<option value="报废品">报废品</option>
						<option value="待处理品">待处理品</option>
						<option value="返修件">返修件</option>
						</select></td>						
						</tr>
						<tr>
						<td>零件号：</td><td><input id="markId" type="text" name="sticker.markId" /></td>
						<td align="center">工<span style="width:7px;"></span>序<span style="width:7px;"></span>号：</td>
						<td><input id="processNO" type="text" name="sticker.processNO" /></td>
						</tr>
						<tr>
						<td>零件名：</td><td><input id="partsName" type="text" name="sticker.partsName" /></td>
						<td align="center">批<span style="width:7px;"></span>次<span style="width:7px;"></span>号：</td>
						<td><input id="lotId" type="text" name="sticker.lotId" /></td>
						</tr>
						<tr>
						<td>员工号：</td><td><input onMouseOut="getUserBy('co',this)" id="code" type="text" name="sticker.code" /></td>
						<td align="center">操<span style="width:7px;"></span>作<span style="width:7px;"></span>者：</td>
						<td><input id="operator" onMouseOut="getUserBy('na',this)" type="text" name="sticker.operator" /></td>
						</tr>
						<tr>
						<td>签<span style="width:14px;"></span>名：</td><td><input readOnly="true" type="text" name="sticker.examinerName" value="<%=username %>"/></td>
						<td align="center">
						...
						<span style="display:none;" id="advise2"><input type="text" name="sticker.treatAdvice" /></span>
						<span style="display:none;" id="advise3"><input type="text" name="sticker.count" value="1"/></span>
						</td>
						</tr>
						<tr><td colspan="4">
						<div id="fp" style="display:block;text-align:center;">
						<table>
							<tr><td colspan="2" align="left">要求检查内容：</td>
							<td colspan="2"><textarea id="demandExamContent" name="sticker.demandExamContent" cols="35" rows="6"></textarea></td></tr>
							<tr><td colspan="2" align="left">实际检查记录：</td>
							<td colspan="2"><textarea id="realExamContent" name="sticker.realExamContent"  cols="35" rows="6"></textarea></td></tr>
						</table>	
						</div>
						...
						<table >
				          ...
				          <td>报废原因：</td>
				         <td> <select id="yuefen" style="width: 100px;" name="sticker.more" ></select>
							
							<!-- <textarea id="demandExamContent" name="sticker.more" cols="35" rows="6"></textarea> --></td></tr>
							<tr style="display:none;text-align:center;" id="t1"><td>责任人：</td><td><input type="text" name="sticker.gongyinshang"/></td></tr>
						</table>	
						</div>
						</td></tr>
						...
						<input style="width:75px;font-size:15px;"  type="reset" value="放弃">
						</td></tr>
					</table>
				</form>
			</div>
