	...
	<body>
		...
		<div id="gongneng"
			...
			<div align="center">
				...
				<form action="storage_addStorage.action"
					onsubmit="return validate()" method="post">
					<input type="hidden" name="vsto.number" value="${vsto.number}" />
					<input type="hidden" name="vsto.jump" value="manual" />
					<table class="table">
						<tr>
							<td align="right">
								编号：
						...
						<tr>
							...
							<td>
								...
								<select name="sf.unit" id="unit">
									<option selected="selected" value="${oa.detailUnit}">
										${oa.detailUnit}
									</option>
								</select>
							</td>
						...
						<tr>
							...
							<td>
								<input type="text" name="sf.beginning_num" value="${oa.beginning_num}"  />
							</td>
