...
<html>
	...
	<form action="ProcardAction!passProcessInfor.action" method="post"
	...
	<div class="row">
		...
		<div class="span6" id="tableDiv" style="display : none">
			...
			<button type="button" class="btn btn-default" id="taskdel" onclick="del();">
							Delete
			</button>
		</div>
		</form>
...
function findAllProcessInfor(){
   ...
   function del(){  
         document.getElementById('myform').action = "ProcardAction!delProcessInfor.action";  
         document.getElementById("myform").submit();  
         document.getElementById('myform').action = "ProcardAction!passProcessInfor.action";
     }  
