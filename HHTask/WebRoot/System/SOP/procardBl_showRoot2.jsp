	...
	<body>
		...
		<div id="gongneng"
			...
			<div align="center">
				...
				<form action="procardBlAction_findRootProcardforblList.action"
					method="post">
				...
				<table  class="table">
					...
					<s:iterator value="procardList" id="pagebl" status="pageStatus">
						...
						<td  colspan="2">
							<input type="button" value="备料" style="height: 20px;width: 80px;" onclick="showDetailForbl(${pagebl.id})">
