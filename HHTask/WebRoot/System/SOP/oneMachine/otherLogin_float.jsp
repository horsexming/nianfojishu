...
var name = '${session.Users.name}';
if ((errorMessage != "" && errorMessage == 'ok')||(name!=null && name!="")) {
...
function toPassword(event) {
	...
	<body bgcolor="#ffffff" onload="autoLogin()">
		<center>
			<div
				style="width: 100%; height: 150px; border: 1px solid #000; background-image: url('${pageContext.request.contextPath}/upload/file/sysImages/tasklogo.jpg');background-repeat:no-repeat; background-size:100% 100%;-moz-background-size:100% 100%;">
			</div>
			<div
				style="border: solid 1px #000000; width: 100%; font-family: 微软雅黑; font-size: 10px; padding-top: 20px;"
				align="center">
						...
						<tr>
							<td colspan="3" align="left">
								...
								<input type="button" value="登录"
									onclick="checkLogin(this.form,'fl')"
