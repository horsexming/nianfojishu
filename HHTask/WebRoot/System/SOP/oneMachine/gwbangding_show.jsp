	...
	<body onload="createDept('dept')">
		...
		<div id="gongneng" style="width: 100%;">
			<div align="center">
				<div>
					给
					<font color="red"> ${machine.omNum} </font>绑定工位
				</div>
				<div>
					<form action="OneMachineAction_findStationCondition.action"
						...
						<table class="table">
							<tr>
								...
								<td>
									<input type="text" name="taSopGongwei.gongweihao" />
								</td>
								<td>
					...
					<hr>
					<form action="OneMachineAction_bindingStation.action" method="post"
						style="margin: 0px">
						<input type="hidden" name="id" value="${id}">
						<table class="table" align="center">
							...
							<s:iterator id="users" value="banggongweiList"
							...
							<s:iterator id="users" value="gongweiList"
								status="ststusfunction">
								<s:if test="#ststusfunction.index%2==1">
									<tr align="center" bgcolor="#e6f3fb"
										onmouseover="chageBgcolor(this)"
