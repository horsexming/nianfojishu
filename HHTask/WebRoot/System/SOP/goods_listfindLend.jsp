...
.chartOptionsFlowTrend p a {
	...
	<body>
		...
		<div align="center">
			...
			<form action="LendNectAction!findAllIsBent.action" method="post">
			...
			<table class="table" style="width: 95%;">
				...
				<s:if test="{list.size()>0}">
					<s:iterator value="list" status="see" id="gs">
						...
						<td align="right" >
							<fmt:formatNumber value="${gs.lendNeckCount}" pattern="#.0000"/>
						</td>
						<td>
							${gs.goodsUnit}
						</td>
						...
						<td>
							...
							<a href="LendNectAction!createOneLend.action?goodsId=${gs.goodsId}">外借</a>
						</td>
