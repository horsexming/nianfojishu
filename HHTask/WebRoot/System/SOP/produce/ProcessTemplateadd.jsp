...
.innerTb {
	...
	<body>
		<center>
			...
			<form action="ProcardTemplateAction!addProcessTemplate.action"
				...
				<table class="table" id="tb">
					<tr>
						...
						<td>
							<select name="processTemplate.productStyle" id="productStyle">
								<option >
									自制
								</option>
								<option >
					...
					<tr>
						...
						<td>
							<select id="zjStatus" name="processTemplate.zjStatus" >
								<option value="yes" >
									yes
								</option>
								<option value="no" >
						...
						<td>
							<select name="processTemplate.isPrice" id="isPrice">
								<option value="yes">
									参与
								</option>
								<option value="no">
					...
					<tr>
						...
						<td>
							<select name="processTemplate.kaoqingstatus" class="yesOrNo" id="kaoqingstatus">
								<option value="是">
									是
								</option>
								<option value="否">
						...
						<td>
							<select name="processTemplate.guifanstatus" id="guifanstatus"> 
								<option value="是">
									是
								</option>
								<option value="否">
						...
						<td>
							<select name="processTemplate.isJisuan" class="yesOrNo2" id="isJisuan">
								<option value="yes">
									是
								</option>
								<option value="no">
					...
					<tr>
						...
						<td>
							<select name="processTemplate.gongzhuangstatus" class="yesOrNo" id="gongzhuangstatus">
								<option value="是">
									是
								</option>
								<option value="否">
					...
					<tr>
						...
						<td>
							<select name="processTemplate.liangjustatus" class="yesOrNo" id="liangjustatus">
								<option value="是">
									是
								</option>
								<option value="否">
					...
					<tr>
						...
						<td>
							<select name="processTemplate.shebeistatus" class="yesOrNo" id="shebeistatus">
								<option value="是">
									是
								</option>
								<option value="否">
					...
					<tr>
						...
						<td>
							<select name="processTemplate.guding" class="yesOrNo">
								<option value="是">
									是
								</option>
								<option value="否">
					...
					<tr>
						<td colspan="6" align="center">
							...
							<s:if test="processTemplate.isNeedFuliao=='yes'">
								<input type="radio" name='processTemplate.isNeedFuliao'
													...
													<td style="border-top: 0px; border-left: 0px"
														...
														<td style="border-top: 0px; border-left: 0px"
															...
															<input type="text"
																...
																name="processTemplate.fuliaoList[<s:property value="#index.index"/>].name"
														...
														<td style="border-top: 0px; border-left: 0px"
															...
															<input
																...
																name="processTemplate.fuliaoList[<s:property value="#index.index"/>].specification"
														...
														<td style="border-top: 0px; border-left: 0px"
															...
															<input id="unit<s:property value="#index.index"/>"
																name="processTemplate.fuliaoList[<s:property value="#index.index"/>].unit"
														...
														<td style="border-top: 0px; border-left: 0px"
															...
															<input id="quanzhi1<s:property value="#index.index"/>"
																name="processTemplate.fuliaoList[<s:property value="#index.index"/>].quanzhi1"
																style="width: 80"
																value="<s:property value="#pagefuliao.quanzhi1"/>">
															:
															<input id="quanzhi2<s:property value="#index.index"/>"
																name="processTemplate.fuliaoList[<s:property value="#index.index"/>].quanzhi2"
																style="width: 80"
...
function findProcessByName(processName){
	$.ajax( {
		...
		success : function(pro) {
			...
			var productStyle= "${procardTemplate.productStyle}";
			if(productStyle=="试制"){
				$("#zjStatus").val("no");
			}else{
...
function addFuliaoLine() {
	...
	var html = "<tr id='fuliaoTr"
			...
			+ "<SELECT id='type"
			+ maxFuLiaoIndex
			+ "' name='processTemplate.fuliaoList["
			+ maxFuLiaoIndex
