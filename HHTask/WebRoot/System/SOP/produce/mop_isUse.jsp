		...
		<div id="gongneng" style="width: 100%;">
			<div align="center">
				...
				<table class="table">
					<tr>
						<th colspan="10">
							<font color="red">件号${manualPlan.markId} 需采购数量:<s:if
									test="manualPlan.outcgNumber!=null && manualPlan.outcgNumber>0">
								${ manualPlan.number-manualPlan.outcgNumber}
								<input type="hidden"
										value="${ manualPlan.number-manualPlan.outcgNumber}"
										id="cgNum" />
								</s:if> <s:else>
								${manualPlan.number}
								<input type="hidden" value="${ manualPlan.number}" id="cgNum" />
								</s:else> </font>
						</th>
					</tr>
					<tr>
				...
				<input type="button" value="MOQ/MPQ申请" onclick="moqsqs()" id="qy_but"
					disabled="disabled"  style="width: 115px;height: 45px;" />
			</div>
		</div>
