...
<html>
	...
	<body>
		...
		<div id="gongneng" style="width: 100%;">
			<div align="right" style="font-size: 13px;color: #000000;font-weight: b">
				...
				<img alt="" src="<%=basePath%>/images/right-arrow16.png" >
				<label id="cbjl" onclick="sbprocessStatus(3)" class="dhlabel">
					项目工程师评审
				</label>
				<img alt="" src="<%=basePath%>/images/right-arrow16.png" >
				<label id="zpgbm" onclick="sbprocessStatus(4)" class="dhlabel">
					指派各部门
				</label>
				<img alt="" src="<%=basePath%>/images/right-arrow16.png" >
				<label id="bmps" onclick="sbprocessStatus(5)" class="dhlabel">
					各部门评审
				</label>
				<img alt="" src="<%=basePath%>/images/right-arrow16.png" >
				<label id="fqrjl" onclick="sbprocessStatus(6)" class="dhlabel">
					设变结论
				</label>
				<img alt="" src="<%=basePath%>/images/right-arrow16.png" >
				<label id="zlgx" onclick="sbprocessStatus(7)" class="dhlabel">
					资料更新
				</label>
				<img alt="" src="<%=basePath%>/images/right-arrow16.png" >
				<label id="glsc" onclick="sbprocessStatus(8)" class="dhlabel">
					关联并通知生产
				</label>
				<img alt="" src="<%=basePath%>/images/right-arrow16.png" >
				<label id="schx" onclick="sbprocessStatus(9)" class="dhlabel">
					上传佐证
				</label>
				<img alt="" src="<%=basePath%>/images/right-arrow16.png" >
				<label id="gb" onclick="sbprocessStatus(10)" class="dhlabel">
					设变关闭
				</label>
				&nbsp;&nbsp;
			</div>
					...
					<s:if test="bbAply.changeremark!=nulll&&bbAply.changeremark=='yes'">
						<form id="pbbremarkForm<s:property value="#bbstatus.index"/>"
							...
							<tr>
								...
								<td align="left">
									<textarea rows="2" name="ptbb.remark" cols="30">${bb.remark}</textarea>
								</td>
								<td align="left">
									${bb.bzStatus}
								</td>
		...
		<div id="cbjldiv" style="display: none;background-color:#CAE1FF;" align="center">
			<h3>
				项目工程师评审
			</h3>
			<s:if test="bbAply.processStatus=='项目工程师评审'">
				<s:iterator value="bbAply.bbJudegeList" id="gcsPepole2">
					<s:if
						test="#gcsPepole2.judgeType=='工程师'&&#session.Users.id==#gcsPepole2.userId">
						<iframe id="showProcess"
							src="procardTemplateGyAction_toSelectSbProcardTemplate.action?id=${bbAply.id}&ptbbJudges.id=${gcsPepole2.id}"
		...
		<div align="center" id="zpgbmdiv" style="display: none;background-color:#CAE1FF;">
			<br>
				...
				<s:iterator value="bbAply.bbJudegeList" id="gcsPepole2">
					<s:if
						...
						<form id="uplvForm" method="post">
							...
							<table class="table">
								<tr>
									<td bgcolor="yellow" colspan="9" align="center">
										各部门评审人员
									</td>
								</tr>
								<tr>
									<td align="center">
										<input name="bbAply.needDeptJudege" type="radio" value="是"
											onclick="needDeptJudege('是')" checked="checked">
										需要各部门评审
										<input name="bbAply.needDeptJudege" type="radio" value="否"
											onclick="needDeptJudege('否')">
										不需要各部门评审
									</td>
									<td id="cprytd" colspan="7" align="center">
										<input type="hidden" id="ptbbJudgesid" name="ptbbJudges.id"
											value="<s:property value="#gcsPepole2.id"/>">
										<input type="hidden" id="selectUserId"
											name="ptbbJudges.selectUserId"
											value="<s:property value="#gcsPepole2.selectUserId"/>">
										<input type="hidden" id="selectUsers2"
											name="ptbbJudges.selectUsers"
											value="<s:property value="#gcsPepole2.selectUsers"/>">
										<label id="selectUsers">
											<s:property value="#gcsPepole2.selectUsers" />
										</label>
									</td>
									<td align="center">
										<input id="selectpjBtn" type="button" value="选择"
											onclick="selectnsPeople(<s:property value="#gcsPepole2.id"/>,'selectUserId','selectUsers2','selectUsers')">
									</td>
								</tr>
								<tr>
									<td colspan="9" align="center">
										<input id="subFormBtn" type="button"
											onclick="submituplvForm()" value="提交"
											style="width: 60px; height: 40px;">
										<input type="button" onclick="backsbApply(${bbAply.id})"
											...
											<s:iterator value="#pabb1.processabbList" id="processabb1"
												...
												<td align="left">
													...
													<select id="clfa<s:property value="#nsIndex1" />"
														...
														class="cl1<s:property value="#pabb1.rootSelfCard" />">
														<s:if
															test="#processabb1.pbbjList!=null&&#processabb1.pbbjList.size()>0">
															<s:iterator value="#processabb1.pbbjList" id="pbbj1">
...
<%--							</td>--%>
		...
		<div id="fqrjldiv" align="center" style="display: none;background-color:#CAE1FF;">
			<h3>
				结论
			</h3>
			<s:if test="bbAply.processStatus=='结论'">
						...
						<form id="jlform" method="post">
							...
							<table class="table">
								...
								<tr>
									<td align="center" colspan="16">
										评论：
										<textarea rows="4" cols="80" name="ptbbJudges.remark"
								...
								<tr>
									<td align="center" colspan="16">
										<input id="jsSubBtn" type="button" onclick="submitnp(2)"
											value="确定" style="width: 80; height: 60px;">
										<input type="button" onclick="backsbApply(${bbAply.id})"
...
var index=0;
var strs1=new Array("fqsb","ffxmz","zgcp","cbjl","zpgbm","bmps","fqrjl","zlgx","glsc","schx","gb");
var strs2=new Array("fqsbdiv","ffxmzdiv","zgcpdiv","cbjldiv","zpgbmdiv","bmpsdiv","fqrjldiv","zlgxdiv","glscdiv","schxdiv","gbdiv");
...
function submitchupin(cpindex){
	...
	$.ajax( {
		...
		success : function(data) {
				alert(data);
				if(data=="提交成功,初评结束!"){
					window.location.href="procardTemplateGyAction_showSbApplyJd.action?bbAply.id=${bbAply.id}";
				}
	}
	});
}
...
function submitnp(tag){
	...
	$ .ajax( {
					type : "post",
					url : "procardTemplateGyAction_submitnp.action",
					data :  form.serialize(),
...
function submitnoprocardns(tag){
	...
	$ .ajax( {
					type : "post",
					url : "procardTemplateGyAction_noprocardns.action",
					data :  form.serialize(),
					dataType : "json",
					success : function(data) {
						btn.removeAttr("disabled");
...
function suresb(){
	...
	$ .ajax( {
					type : "post",
					url : "procardTemplateGyAction_suresb.action",
...
function submituplvForm(){
	...
	$ .ajax( {
					...
					success : function(data) {
						...
						alert(data);
						parent.window.location.href="procardTemplateGyAction_showSbApplyJd.action?bbAply.id=${bbAply.id}";
			}
	});
}
function selectnsPeople(id,idname1,idname2,idname3){
	...
	$("#showProcess").attr("src","procardTemplateGyAction_findAboutDept.action?ids="+ids+"&idname1="+idname1+"&idname2="+idname2+"&idname3="+idname3);
}

function backsbApply(id){
	window.location.href="procardTemplateGyAction_backsbApply.action?id="+id;
}
	...
	if(confirm("是否确定打回?")){
		$ .ajax( {
					...
					success : function(data) {
						if(data=="true"){
							alert("打回成功!");
							window.location.href="procardTemplateGyAction_showSbApplyJd.action?bbAply.id="+id;
						}else{
							alert(data);
						}
