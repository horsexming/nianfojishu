...
<html>
	...
	<body>
		...
		<div id="gongneng" style="width: 100%;">
			<div align="center">
			<form action="procardTemplateGyAction_daoRuHwSZBom.action" method="post" enctype="multipart/form-data" onsubmit="return validate();">
				...
				<div id="rootTemplateDiv">
					...
					<table class="table">
						...
						<s:iterator value="procardTemplateList" id="pageProcardTem"
							...
							<td align="center">
								<a onclick="daochu(${pageProcardTem.id})">导出</a>
							</td>
							</tr>
						</s:iterator>
						<tr>
