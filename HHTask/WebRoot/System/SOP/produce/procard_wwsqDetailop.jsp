					...
					<tr>
						...
						<form action="ProcardAction!deleteWwApplyDetails.action?" method="POST">
							<table class="table" style="border-collapse: collapse;">
								<tr>
									<th>
										<input type="checkbox"   id="checkAll" onclick="chageAllCheck(this)"/>
								...
								<s:iterator value="pwwApply.detailList" id="pagedetail"
									...
									<s:elseif test="#pagedetail.deleteStatus=='申请中'">
										<a href="CircuitRunAction_findAduitPage.action?id=${pagedetail.deleteEpId}">删除申请中</a>
									</s:elseif>
									<s:else>
										<input type="checkbox" value="${pagedetail.id}" name="processIds" onchange="chageNum()"/>
									</s:else>
									</td>
									<td align="center">
							...
							<s:if test="pwwApply.userCode==#session.Users.code">
								<s:if test="pwwApply.processStatus=='预选未审批'||pwwApply.processStatus=='合同待确认'">
									<div align="center">删除原因:<textarea name="remark" rows="4" cols="10"></textarea> </div>
									<div  align="center">
