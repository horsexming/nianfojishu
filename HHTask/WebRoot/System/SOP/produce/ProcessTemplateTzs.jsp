	...
	<body>
		...
		<div id="gongneng" style="width: 100%;">
			<div align="center">
				...
				<form action="ProcardTemplateAction!updateProcessTz.action" enctype="multipart/form-data" method="post">  
				<table class="table">
				...
				<s:iterator value="list" id="spFile">
				 <s:if test="#spFile.type=='视频文件'">
				  <tr>
				   ...
				   <td><a href="procardTemplateGyAction_DownloadProcessTz.action?id=${spFile.id}">下载</a>&nbsp;&nbsp;
...
<%--									href="<%=path%>/upload/file/processTz/${qxFile.month}/<s:property value="#qxFile.fileName"/>">--%>
									...
									<s:property value="#qxFile.fileName"/>"
								</a>
							</td>
							<td align="left">
								${oldfileName}
				...
				<s:iterator value="list" id="file3D">
				 <s:if test="#file3D.type=='3D文件'">
				  <tr>
				   ...
				   <td><a href="procardTemplateGyAction_DownloadProcessTz.action?id=${file3D.id}">下载</a>&nbsp;&nbsp;
...
<%--				   <td align="left"><a  target="_showPri" href="<%=path%>/upload/file/processTz/${tzFile.month}/<s:property value="#tzFile.fileName"/>"> <img src="<%=path%>/upload/file/processTz/${tzFile.month}/<s:property value="#tzFile.fileName"/>"  style="width:80px;height:80px;"/></a> </td>--%>
				   <td align="left"><a  target="_showPri" href="<%=basePath%>FileViewAction.action?FilePath=/upload/file/processTz/${tzFile.month}/<s:property value="#tzFile.fileName"/>&Rename=<s:property value="#tzFile.oldfileName"/>"> <s:property value="#tzFile.fileName"/></a> </td>
				   ...
				   <td><a href="procardTemplateGyAction_DownloadProcessTz.action?id=${tzFile.id}">下载</a>&nbsp;&nbsp;
				...
				<s:iterator value="list" id="sopFile">
				 <s:if test="#sopFile.type=='SOP文件'">
				  <tr>
				   ...
				   <td><a href="procardTemplateGyAction_DownloadProcessTz.action?id=${sopFile.id}">下载</a>&nbsp;&nbsp;
				...
				<s:iterator value="list" id="sapFile">
				 <s:if test="#sapFile.type=='SIP文件'">
				  <tr>
				   ...
				   <td><a href="procardTemplateGyAction_DownloadProcessTz.action?id=${sapFile.id}">下载</a>&nbsp;&nbsp;
				...
				<s:iterator value="list" id="modelFile">
				 <s:if test="#modelFile.type=='3D模型'">
				  <tr>
				   ...
				   <td><a href="procardTemplateGyAction_DownloadProcessTz.action?id=${modelFile.id}">下载</a>&nbsp;&nbsp;
...
<%--				   <td align="left"><a href="<%=path%>/upload/file/processTz/${cxFile.month}/<s:property value="#cxFile.fileName"/>"> <img src="<%=path%>/upload/file/processTz/${cxFile.month}/<s:property value="#cxFile.fileName"/>"  style="width:80px;height:80px;"/></a> </td>--%>
				   <td align="left"><a href="<%=basePath%>FileViewAction.action?FilePath=/upload/file/processTz/${cxFile.month}/<s:property value="#cxFile.fileName"/>&Rename=<s:property value="#cxFile.oldfileName"/>"> <s:property value="#cxFile.fileName"/></a> </td>
				   ...
				   <td><a href="procardTemplateGyAction_DownloadProcessTz.action?id=${cxFile.id}">下载</a>&nbsp;&nbsp;
...
<%--				   <td align="left"><a href="<%=path%>/upload/file/processTz/${ncFile.month}/<s:property value="#ncFile.fileName"/>"> <img src="<%=path%>/upload/file/processTz/${ncFile.month}/<s:property value="#ncFile.fileName"/>"  style="width:80px;height:80px;"/></a> </td>--%>
				   <td align="left"><a href="<%=basePath%>FileViewAction.action?FilePath=/upload/file/processTz/${ncFile.month}/<s:property value="#ncFile.fileName"/>&Rename=<s:property value="#ncFile.oldfileName"/>"><s:property value="#ncFile.fileName"/></a> </td>
				   ...
				   <td><a href="procardTemplateGyAction_DownloadProcessTz.action?id=${ncFile.id}">下载</a>&nbsp;&nbsp;
...
<%--				   <td align="left"><a href="<%=path%>/upload/file/processTz/${lsFile.month}/<s:property value="#lsFile.fileName"/>"> <img src="<%=path%>/upload/file/processTz/${lsFile.month}/<s:property value="#lsFile.fileName"/>"  style="width:80px;height:80px;"/></a> </td>--%>
				   <td align="left"><a href="<%=basePath%>FileViewAction.action?FilePath=/upload/file/processTz/${lsFile.month}/<s:property value="#lsFile.fileName"/>&Rename=<s:property value="#lsFile.oldfileName"/>"><s:property value="#lsFile.fileName"/></a> </td>
				   ...
				   <td><a href="procardTemplateGyAction_DownloadProcessTz.action?id=${lsFile.id}">下载</a>&nbsp;&nbsp;
...
function deletetz(fileId,id){
	if(window.confirm("确认要删除该条记录?")){
		window.location.href="ProcardTemplateAction!deleteProcessTz.action?processTemplateFile.id="+fileId+"&pageStatus=${pageStatus}&id="+id
	}
