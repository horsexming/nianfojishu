	...
	<body>
			...
			<div id="closeDiv"
				...
				<div id="operatingDiv" align="center"
					...
					<table class="table">
						...
						<tr><td align="center" colspan="2"><input type="button" value="领取" onclick="out()" style="width: 60px;height: 40px;">
							</td>
						</tr>
					</table>
				</div>
		...
		<div id="gongneng" style="width: 100%;">
			<div align="center">
				<h3>半成品领料列表</h3>
				<br/>
				<form action="goodsAction!findwxzwwList.action" method="post">
				<input type="hidden" id="role2" name="role" value="2">
					<table class="table">
						<tr>
							<th align="right">
								件号
				...
				<tr>
					...
					<input type="submit" value="批量领料" style="width: 80px;height: 60px;" onclick="todisabled(this)" >
					</td>
				</tr>
				</table>
				</form>
