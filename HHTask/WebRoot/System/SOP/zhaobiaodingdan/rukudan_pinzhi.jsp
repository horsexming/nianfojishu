...
<html>
	...
	<body  >
		<center>
			<form action="DingdanAction!updateRukudanpinzhi.action" method="post"
				theme="simple">
					...
					<th align="center" colspan="5">
						...
						<th align="right">送货单号:</th>
							...
							<tr><th align="right">采购经办人:</th>
							 ...
							 <th align="right">申请单编号:</th>
							    <td><input type="text"  name="rukudan.rukubianhao" value="${rukudan.rukubianhao}"    readonly="readonly"/></td>
							</tr>
						...
						<tr><td colspan="4" align="left"><font style="color: red;">技术质保部（品质)</font></td></tr>	
							<tr><th align="right" >批次号:</th>
							    <td ><input type="text"  name="rukudan.picihao"/>
							    <th align="right" >验收结论:</th>
							    <td >
							    <input type="radio"  name="rukudan.yanshou" value="同意" checked="checked" />同意
							    	<input type="radio"  name="rukudan.yanshou" value="退回" />退回
							   </td>
							    
							</tr>
							<tr>
							<th align="right">炉批号:</th>
							    <td><input type="text"  name="rukudan.lupihao" value=""/></td>
							    <th align="right">质量反馈单编号:</th>
							    <td><input type="text"  name="rukudan.fankuihao"  "/>
							    </td>
							</tr>
							<tr>
							<th align="right">品质经办人:</th>
							    <td><input type="text"  name="rukudan.pinzhiren" value="${sessionScope.Users.name}"/></td>
							    <th align="right"></th>
							    <td>
							    </td>
							</tr>
