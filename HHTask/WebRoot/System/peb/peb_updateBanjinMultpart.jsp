...
.ui-rangeSlider-label {
	...
	<body bgcolor="#ffffff">
		<div class="container">
			<form action="productEBAction!updateBanjinMultpart.action" method="post"  id="myform" autocomplete=off >
				<div class="row clearfix">
					...
					<div class="form-group col-lg-6">
	                    <div class="input-group">
	                        ...
	                        <input class="form-control" type="text" name="banjin.processName" >
	                    </div>
	                </div>
	                <div class="form-group col-lg-6">
	                    <div class="input-group">
	                        <span class="input-group-addon">系数</span>
	                        <input class="form-control" type="text" name="banjin.xiShu">
	                    </div>
	                </div>
	            </div>
	            <div class="row clearfix">
