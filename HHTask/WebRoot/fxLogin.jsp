...
function submitLogin(tag) {
	...
	loginForm.action = "UsersAction!jyLogin2.action";
	loginForm.submit();
		...
		<div class="content">
			...
			<div class="loginbox">
				<form id="loginForm" class="logininfo"
					action="UsersAction!jyLogin2.action" method="post" target="_top">
					<input id="tag" name="tag" type="hidden" value="sjlogin" />
					<div class="form-item">
						<label>
							<img src='img/user.png' height="19" width="20">
						</label>
						<input type="text" placeholder="老师编号" name="user.code" id="code"
							value="${user.code}">
					</div>
					<div class="form-item">
						<label>
					...
					<div class="form-item last">
						...
						<span>一周内自动登录</span>
						<select style="margin-left: 60px;display: none;" name="pageStatus" id="loginType" >
							<option value="">
								简约首页
							</option>
							<option value="qx">
