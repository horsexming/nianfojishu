 ...
 *
 */
public class ImproveKVP implements Serializable {
	private static final long serialVersionUID = 1L;
	private Integer id;
	private String improved_beforeproblems; // 改进前的问题
	private String improved_endproblems;// 改进后的问题
	private String beforeimage_Path;// 改进前图片
	private String afterimage_Path;// 改进后图片
	private KVPAssess kvpAssess;// 关联kvp主表
	...
	public String getBeforeimage_Path() {
		return beforeimage_Path;
	}

	public void setBeforeimage_Path(String beforeimagePath) {
		beforeimage_Path = beforeimagePath;
	}

	public String getAfterimage_Path() {
		return afterimage_Path;
	}

	public void setAfterimage_Path(String afterimagePath) {
		afterimage_Path = afterimagePath;
	}
