	...
	<body>
		...
		<div id="gongneng"
			...
			<div align="center">
				...
				<form action="outlib_scanCardLingyong.action" method="post">
					<table>
						<tr>
							<td>请刷员工卡</td>
							<td>
				...
				<table class="table">
					...
					<s:iterator value="list" id="pageList" status="pageStatus">
						...
						<Td>
							...
							<a href="store_initBorrowOrConsuming.action?cardNum=${cardID}&id=${pageList.id}&vos.formUrl=consuming&pageStauts=fh">领用</a>
						<!-- 
