		...
		<div id="gongneng"
			...
			<div align="center">
				...
				<table width="100%" border="0" style="border-collapse: collapse;"
					...
					<s:iterator value="askList" id="pageAskForLeave"
						status="pageStatus">
						...
						<s:if test="">
							...
							<a onclick="return window.confirm('该请假申请将被审核通过,确定提交?')"
								href="AskForLeaveAction!approvalByOkOrBack.action?pageStatus=ok&id=${pageAskForLeave.leaveId}"><font
								color="red">同意</font> </a>
							<hr>
							<a onclick="return window.confirm('该请假申请将被打回,确定提交?')"
								href="AskForLeaveAction!approvalByOkOrBack.action?pageStatus=back&id=${pageAskForLeave.leaveId}"><font
								color="red">打回</font> </a>
						</td>
						</tr>
					</s:iterator>
