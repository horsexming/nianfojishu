...
<html>
	...
	<body>
<center>
				<form action="markIdAction!addwaigoujianpinci.action" method="post"
					theme="simple">
					...
					<tr><th colspan="2" align="center" id="th_1">外购外协件验收频次规定</th></tr>
						...
						<tr id="tr_1">
							...
							<td>
								<input type="text" id="waigoujianpinci.jiepai" name="waigoujianpinci.jiepai"  />
							</td>
						</tr>
						<tr id="tr_2">
							<th align="right">
							...
							<td>
								<textarea rows="2" cols="50" id="waigoujianpinci.shuoming"
									name="waigoujianpinci.shuoming" /></textarea>
							</td>
						</tr>
						<tr>
