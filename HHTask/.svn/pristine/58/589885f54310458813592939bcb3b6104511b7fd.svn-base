...
public class GoodsStore   implements java.io.Serializable{
	...
	private Double hsPrice;// 单价(含税)
	private Double goodsStorePrice;// 单价(不含税)
	...
	private String goodsStoreLuId;// 炉号(需求部门)
	...
	private String style;// 入库类型（领用、可借用。
	...
	public GoodsStore(Integer goodsStoreId, String goodsStoreWarehouse,
			String goodHouseName, String goodsStorePosition,
			String goodsStoreMarkId, String banBenNumber, String kgliao,
			String goodsStoreLot, String goodsStoreGoodsName,
			String goodsStoreFormat, String wgType, String goodsStoreUnit,
			Float goodsStoreCount, String goodsStoreDate, String style,
			String more, Integer sellId, String changePrint,
			String sellWarehouse, String sellHouseName, String sellKuwei) {
		super();
