...
<html>
	...
	<body onload="createDept('dept')">
		...
		<div id="gongneng" style="width: 100%;">
			<div align="center">
				<h3>
					您正在给<font color="red"> ${toolCabine.cabNumber} </font>柜子绑定用户
				</h3>
				<div>
					<form action="ToolCabineAction_findToolCabCondition.action?tag=${tag}"
						...
						<table class="table">
							<tr>
								...
								<td rowspan="2">
									<input type="hidden" name="toolCabine.id"
										value="${toolCabine.id}">
									<input type="submit" value="查询"
										style="width: 100px; height: 50px;" /> 
									<input type="button" value="返回" onclick="banke()"
										style="width: 100px; height: 50px;" />
								</td>
							</tr>
							<tr>
					...
					<hr>
					<form action="ToolCabineAction_bindingUsers.action?tag=${tag}"
						method="post" style="margin: 0px">
						<input type="hidden" name="toolCabine.id"
							value="${toolCabine.id}">
...
function banke(){
	window.location.href = "ToolCabineAction_showList.action?tag=${tag}";
}
