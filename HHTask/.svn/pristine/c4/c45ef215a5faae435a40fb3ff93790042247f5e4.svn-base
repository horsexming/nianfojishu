...
<html>
	...
	<body>
<center>
				<form id="myForm" action="OsTemplate_UpdateOsScope.action" method="post" enctype="multipart/form-data" onsubmit="return check();">
					<table>
					<tr><th colspan="2" align="center">修改检查项</th></tr>
						<tr>
						...
						<tr>
							...
							<td><input name="tt.jcff" value="${tt.jcff}"/></td>
						</tr>
						<tr><th align="center">	<input type="submit" value="提交" class="input"></th></tr>
					</table>
