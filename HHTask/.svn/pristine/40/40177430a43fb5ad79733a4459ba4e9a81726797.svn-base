				...
				<form id="addForm" action="ProjectStartUser_add.action" method="post" >
					...
					<table class="table" style="width: 50%" >
						...
						<tr>
							...
							<td><input id="userCard" name="p.userCard"/></td>
							<th align="right">姓名</th>
							<td><input readonly="readonly" id="inCharge"/></td>
						</tr>
						<tr>
							<th align="right">部门</th>
							<td><input readonly="readonly" id="dept" /></td>
							<th align="right">手机</th>
							<td><input name="user.telphone"/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td colspan="3">
								<textarea rows="6" cols="40" name="user.responsibilities"></textarea>
							</td>
						</tr>
						<tr>
