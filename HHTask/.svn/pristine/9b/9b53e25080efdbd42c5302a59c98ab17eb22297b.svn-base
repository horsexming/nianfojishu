...
<%--									<textarea rows="2" cols="50" name="improveKVPList[0].improved_beforeproblems"></textarea>--%>
								<div style="position: relative;left: 0px;top: 0px;">
												<textarea id="content"  name="kvpAssess.improved_beforeproblems" cols="10" rows="4"  style="width:350px;height:100px;visibility:hidden;">${kvpAssess.improved_beforeproblems}</textarea>	
										</div>
							</th>
							<th colspan="2" >
<%--									<textarea rows="2" cols="50" name="improveKVPList[0].improved_endproblems"></textarea>--%>
										<div style="position: relative;left: 0px;top: 0px;">
												<textarea id="content1" name="kvpAssess.improved_endproblems" cols="10" rows="4"  style="width:350px;height:100px;visibility:hidden;">${kvpAssess.improved_endproblems}</textarea>	
										</div>
							</th>
							<th>
							<input type="text" name="kvpAssess.quality_assessment" value="${kvpAssess.quality_assessment}">
							</th>
							</tr>
							<tr>
							<th colspan="5"> </th>
...
<%--						</tr>--%>
						<tr>
							...
							<th>
							<s:if test="kvpAssess.assessment_findings=='是'.toString()">
							...
							<s:else>
							 <input type="radio"  id="aaa" name="kvpAssess.assessment_findings" value="是" />
									<label for="aaa">
										是
									</label>
									<input type="radio"  id="bbb"  name="kvpAssess.assessment_findings"  value="否"  checked="checked"/>
									<label for="bbb">
										否
									</label>
							</s:else>
						...
						<tr id="button1">
								...
								<input type="hidden" name="kvpAssess.status"  value="${kvpAssess.status}"> 
...
$(function(){
	...
	function submit(){
		...
		$.ajax({
							type: "POST",
							url: "kvpAssessAction_doupdateKVPAssess.action",
