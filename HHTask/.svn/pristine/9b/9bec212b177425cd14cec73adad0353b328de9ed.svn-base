 ...
 * 
 */
public class ProcardTemplateBanBenApply implements Serializable {
	/**
	 * 
	 */
	...
	private String dqclUser;//当前处理人（页面显示）
	private String qxRemark;//取消时填写的备注
	/****
	 * 华为EC对接
	 */
	...
	public String getDqclUser() {
		return dqclUser;
	}
	public void setDqclUser(String dqclUser) {
		this.dqclUser = dqclUser;
	}
	public String getQxRemark() {
		return qxRemark;
	}
	public void setQxRemark(String qxRemark) {
		this.qxRemark = qxRemark;
	}
