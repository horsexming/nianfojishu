				...
				<form action="markIdAction!addwaigoujianpinciZi.action" method="post"
					...
					<tr><th colspan="2" align="center">巡检批量</th></tr>
						...
						<tr>
							...
							<td>
								<input  type="text"  id="waigoujianpinciZi.ybCode"   name="waigoujianpinciZi.ybCode"  />
							</td>
						</tr>
						<tr>
							<th align="right">
						...
						<tr>
							...
							<td>
								<input  type="text"  id="waigoujianpinciZi.ac"   name="waigoujianpinciZi.ac"  />
							</td>
						</tr>
						<tr>
							<th align="right">
							...
							<td>
								<input  type="text"  id="waigoujianpinciZi.re"   name="waigoujianpinciZi.re"  />
							</td>
						</tr>
						<tr>
							<th align="right">
						...
						<tr>
							...
							<td>
								<input  type="text"  id="waigoujianpinciZi.ac1"   name="waigoujianpinciZi.ac1"  />
							</td>
						</tr>
						<tr>
							<th align="right">
							...
							<td>
								<input  type="text"  id="waigoujianpinciZi.re1"   name="waigoujianpinciZi.re1"  />
							</td>
						</tr>
