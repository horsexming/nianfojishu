...
$(function() {
	$('#tab').treegrid( {
		url : 'QuotedPrice_initTrial.action?id=${param.id}',
		singleSelect : true,
		toolbar : '#tb',
		idField : 'id',
		treeField : 'name',
...
function trial(id) {
	var bol = ergodic();
	window.location = "QuotedPrice_trial.action?id=" + id;
}
var index = 0;
function ergodic() {
	if (list) {
	...
	<body>
		...
		<div id="tb" style="height: auto">
			...
			<a href="javascript:void(0)" class="easyui-linkbutton"
				...
				onclick="trial(${param.id})">计算人工费</a>
