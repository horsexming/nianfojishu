...
$.ajax( {
	...
	success : function(object) {
		...
		$.each(object, function(i, obj) {
			$(bj += "<option value='"
					+ [ obj.paihao, obj.guige, obj.jiage, obj.danwei ] + "'>牌号:"
					+ obj.paihao + "                规格:" + obj.guige
					+ "</option>");
		});
...
$(function() {
	jisuanWage();
	var paihao=document.getElementById("paihao").value;
				...
				<div id="xitong"
					...
					<div style="float: left; width: 45%; padding-top: 5px;"
						...
						<a
							...
							style="color: #ffffff">更新外委产品申报单</a>
					</div>
				</div>
				<div align="center">
					<form action="osaAction!updateOSAById.action" method="post"
						onsubmit="return chackForm()" enctype="multipart/form-data">
						<input type="hidden" name="osa.id" value="${osa.id}" />
						<input type="hidden" name="osa.number" value="${osa.number}" />
						<table width="100%" border="0" class="table">
							...
							<tr>
								...
								<td>
									<input type="text" name="osa.dept" class="horizontalLine"
										value="<%=user.getDept()%>" readonly="readonly"
								...
								<td>
									<input id="customer" name="osa.customer"
										value="${osa.customer}" class="horizontalLine"
										onfocus="chageClass(this,'')"
										onblur="chageClass(this,'horizontalLine')">
									<font color="red"> *</font>
								</td>
							...
							<tr>
								...
								<td>
									<input id="markID" name="osa.markID" value="${osa.markID}"
								...
								<td>
									<input id="processNO" name="osa.processNO"
										value="${osa.processNO}" class="horizontalLine"
										onfocus="chageClass(this,'')"
										onblur="chageClass(this,'horizontalLine')">
									<font color="red"> *</font>
								</td>
								...
								<td>
									<input onkeyup="this.value=this.value.replace(/\D/g,'')"
										...
										value="${osa.deliveryCount}" class="horizontalLine"
										onfocus="chageClass(this,'')"
										onblur="chageClass(this,'horizontalLine')">
									<font color="red"> *</font>
								</td>
							...
							<tr>
								...
								<td>
									<select id="orderId" name="osa.orderId" style="width: 155px;">
										<option value="${osa.orderId}" selected="selected">
											${osa.orderId}
										</option>
									</select>
									<font color="red"> *</font>
								...
								<td>
									<input id="yuceCount" name="osa.yuceCount"
										value="${osa.yuceCount}" class="horizontalLine"
										onfocus="chageClass(this,'')"
										onblur="chageClass(this,'horizontalLine')">
							...
							<tr>
								...
								<td>
									<input id="procardCycle" name="osa.procardCycle"
										value="${osa.procardCycle}" class="horizontalLine"
										onfocus="chageClass(this,'')"
										onblur="chageClass(this,'horizontalLine')">
								...
								<td>
									<input id="productCysle" name="osa.productCysle"
										value="${osa.productCysle}" class="horizontalLine"
										onfocus="chageClass(this,'')"
										onblur="chageClass(this,'horizontalLine')">
							...
							<tr>
								...
								<td>
									<select id="alertNum" name="osa.alertNum"
										class="horizontalLine">
										<option value="${osa.alertNum}">
											${osa.alertNum}
										</option>
									</select>
									<font color="red"> *</font>
								...
								<td>
									<input onkeyup="this.value=this.value.replace(/\D/g,'')"
										...
										value="${osa.repairCycle}" onfocus="chageClass(this,'')"
										onblur="chageClass(this,'horizontalLine')">
									<font color="red"> 天*</font>
								</td>
							</tr>
							<tr>
								...
								<td>
									<select id="machineFail" name="osa.machineFail"
										style="width: 130px;">
										<option value="">
											请选择原因
										</option>
								...
								<td>
									<input name="osa.repairBudget" class="horizontalLine"
										value="${osa.repairBudget}" onfocus="chageClass(this,'')"
										onblur="chageClass(this,'horizontalLine')">
								</td>
							...
							<tr>
								...
								<td>
									<select id="nation" name="osa.abilityLack"
										...
										<option value="${osa.abilityLack}" selected="selected">
											${osa.abilityLack}
										</option>
										<option value="人员不足">
											人员不足
							...
							<tr>
								...
								<td>
									<select id="yuancailiao" name="yuancailiao"
										...
										<option value="[${osa.paihao},${osa.guige},${osa.jiage},${osa.danwei}]">牌号:${osa.paihao}   规格:${osa.guige}</option>
									</select>
									<input type="hidden" id="paihao" name="osa.paihao"
										value="${osa.paihao}" style="width: 50px;" />
									<input type="hidden" id="guige" name="osa.guige"
										value="${osa.guige}" style="width: 50px;" />
									<input type="hidden" id="jiage" name="osa.jiage"
										value="${osa.jiage}" style="width: 50px;" />
								...
								<td>
									<input type="text" id="shuliang" name="osa.shuliang"
										value="${osa.shuliang}" onchange="getZonge();" />
								</td>
								<th align="right">
									单位：
								</th>
								<td>
									<input type="text" id="danwei" name="osa.danwei"
										value="${osa.danwei}" style="width: 50px;" />
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<input id="osOneRengong" name="osa.osOneRengong"
										value="${osa.osOneRengong}" class="horizontalLine"
										onfocus="chageClass(this,'')"
								...
								<td>
									<input id="osOneMater" name="osa.osOneMater"
										value="${osa.osOneMater}" class="horizontalLine"
										onfocus="chageClass(this,'')"
										onblur="chageClass(this,'horizontalLine')">
									<font color="red"> 元*</font>
								</td>
								...
								<td>
									<input id="osOneOthsers" name="osa.osOneOthsers"
										value="${osa.osOneOthsers}" class="horizontalLine"
										onfocus="chageClass(this,'')"
										onblur="chageClass(this,'horizontalLine')">
									<font color="red"> 元*</font>
								</td>
							...
							<tr>
								...
								<td>
									<input id="addWorker"
										...
										name="osa.addWorker" class="horizontalLine"
										value="${osa.addWorker}" onfocus="chageClass(this,'')"
								...
								<td>
									<input id="oneWorkerMoney" name="osa.oneWorkerMoney"
										class="horizontalLine" value="${osa.oneWorkerMoney}"
										onfocus="chageClass(this,'')"
										onblur="chageClass(this,'horizontalLine')">
							...
							<tr>
								...
								<td>
									<input id="addMachineCost" name="osa.addMachineCost"
										value="${osa.addMachineCost}" class="horizontalLine"
										onfocus="chageClass(this,'')"
										onblur="chageClass(this,'horizontalLine')">
									<font color="red"> 元*</font>
								</td>
								...
								<td>
									<input id="zhejiuCost" name="osa.zhejiuCost"
										value="${osa.zhejiuCost}" class="horizontalLine"
										onfocus="chageClass(this,'')"
										onblur="chageClass(this,'horizontalLine')">
									<font color="red"> 元*</font>
								</td>
								...
								<td>
									<input id="recoryPeriod" name="osa.recoryPeriod"
										value="${osa.recoryPeriod}" class="horizontalLine"
										onfocus="chageClass(this,'')"
										onblur="chageClass(this,'horizontalLine')">
									<font color="red"> 年*</font>
								</td>
							...
							<tr>
								...
								<td>
									<input id="addAssistWorker" value="${osa.addAssistWorker}"
										onkeyup="this.value=this.value.replace(/\D/g,'')"
								...
								<td>
									<input id="oneAssistWorkerMoney"
										value="${osa.oneAssistWorkerMoney}"
...
/*
 $(function(){
 val value='';
 $('#yuancailiao').find("option[value='"+value+"']").attr("selected",true);
 });
 */
</script>
