	...
	if (errorMessage == "修改成功") {
		...
		<div id="gongneng" style="width: 100%; margin-top: 10px;">
			...
			<div align="center">
				...
				<form action="AccessEquipmentAction_updateAT.action"
						...
						<table class="table">
							<tr style="width: 100%">
								<th align="center">
									...
									<input type="hidden" name="accessTime.id"
										value="${accessTime.id}" />
								</th>
								<td align="center">
									<input class="Wdate" type="text" name="accessTime.startTime"
										id="startTime" onclick="WdatePicker({dateFmt:'HH:mm:ss',skin:'whyGreen'})" value="${accessTime.startTime}"/>
								</td> 
								<th align="center">
									结束时间
								</th>
								<td align="center">
									<input class="Wdate" type="text" name="accessTime.endTime"
										id="endTime" onclick="WdatePicker({dateFmt:'HH:mm:ss',skin:'whyGreen'})" value="${accessTime.endTime}"/>
								</td>
							</tr>
							<tr>
