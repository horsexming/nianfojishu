...
public interface ProcardTemplateGyServer {
	 ...
	 * @return
	 */
	String quxiaoSb(ProcardTemplateBanBenApply bbAply);
	 ...
	 * 导入流水分工BOM(黎阳[机匣]) 
	 */
	String daoruLyJxBOM(File bomTree, String bomTreeFileName,String productStyle);
	/**
	 * 将Id(procardTemplate)下面的东西复制到id2(procard)下面
	 * @param id
	 * @param id2
	 * @return
	 */
	String copySonsPttoProcard(Integer id, Integer id2);

	/**
	 * 
	 */
	String addProcardTemLyJx(List<ProcardTemplate> ptList,Integer belongLayer
			,String zcMakrId, Users user,Map<String,ProcardTemplate> map,String productStyle);

	String copySonProcardTemplates(Integer id, Integer id2);
}
