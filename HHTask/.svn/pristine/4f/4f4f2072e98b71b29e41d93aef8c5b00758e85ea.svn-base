...
<html>
	...
	<script type="text/javascript">
    	function chageType(obj,form){
    		if(obj.id=="ok"){
    			form.action="SubMonthMoneyAction!updateExamDmBudget.action?tag=ok&pageStatus=1";
    			form.submit();
    		}else if (obj.id=="ng"){
    			form.action="SubMonthMoneyAction!updateExamDmBudget.action?tag=ng&pageStatus=1";
    			form.submit();
    		}
    	}
