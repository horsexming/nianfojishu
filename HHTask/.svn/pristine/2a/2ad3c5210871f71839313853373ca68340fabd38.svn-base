						...
						<tr>
							...
							<td>
								<select name="wstqmx.dept" id="dept">
									<option value="${wstqmx.dept}">${wstqmx.dept}</option>
								</select>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input type="text" value="${wstqmx.tiquMoney}" name="wstqmx.tiquMoney" id="tiquMoney"
									 />
							</td>
						</tr>
						<tr>
							...
							<td>
								<input type="text" value="${wstqmx.months}" name="wstqmx.months" id="months" class="Wdate" 
