...
<html>
	...
	<body>
		<center>
			...
			<form action="procardTemplateSbAction_updateProcessT.action"
				method="post" onsubmit="return checkForm();">
				<input type="hidden" name="processTemplatesb.id"
					id="processTemplateid" value="${processTemplatesb.id}">
				<input type="hidden" name="processTemplatesb.parallelId"
					value="${processTemplatesb.parallelId}">
				<h2>
					工序信息
				</h2>
				...
				<table class="table" id="tb">
					<tr>
						...
						<td>
							<input type="text" name="processTemplatesb.processNO"
								value="${processTemplatesb.processNO}" />
						</td>
						<th align="right">
							工序名称:
						</th>
						<td>
							<select id="processName" name="processTemplatesb.processName"
								style="width: 150px;" onchange="getMachineBygongxu();">
								<option value="${processTemplatesb.processName}">
									${processTemplatesb.processName}
								</option>
							</select>
							<!--    "
							<input type="text" name="processTemplatesb.processName"
								value="${processTemplatesb.processName}" /> -->
						</td>
						<th align="right">
							生产类型:
						</th>
						<td>
							<select name="processTemplatesb.productStyle">
								<option value="${processTemplatesb.productStyle}">
									${processTemplatesb.productStyle}
								</option>
								<option>
									自制
								</option>
					...
					<tr>
						...
						<td>
							<select id="processStatus" name="processTemplatesb.zjStatus">
								<option value="${processTemplatesb.zjStatus}">
									${processTemplatesb.zjStatus}
								</option>
								<option value="no">
									no
								</option>
						...
						<td>
							<select id="processStatus" name="processTemplatesb.processStatus">
								<option value="${processTemplatesb.processStatus}">
									<s:if test="processTemplatesb.processStatus=='yes'">
										并行
									</s:if>
									<s:else>不并行</s:else>
								</option>
						...
						<td>
							<select name="processTemplatesb.isPrice">
								<option value="${processTemplatesb.isPrice}">
									<s:if test="processTemplatesb.isPrice=='yes'">
										参与
									</s:if>
									<s:else>不参与</s:else>
								</option>
					...
					<tr>
						...
						<td>
							<select name="processTemplatesb.kaoqingstatus">
								<s:if test="processTemplatesb.gongzhuangstatus!=null">
									<option value="${processTemplatesb.kaoqingstatus}">
										${processTemplatesb.kaoqingstatus}
									</option>
								</s:if>
								<option value="是">
									是
						...
						<td>
							<select name="processTemplatesb.guifanstatus">
								<s:if test="processTemplatesb.gongzhuangstatus!=null">
									<option value="${processTemplatesb.guifanstatus}">
										${processTemplatesb.guifanstatus}
									</option>
								</s:if>
								<option value="是">
									是
						...
						<td>
							<select name="processTemplatesb.isJisuan">
								<s:if
									test="processTemplatesb.isJisuan!=null&&processTemplatesb.isJisuan=='no'">
									<option value="no">
										否
									</option>
									<option value="yes">
					...
					<tr>
						...
						<td>
							<select name="processTemplatesb.gongzhuangstatus">
								<s:if test="processTemplatesb.gongzhuangstatus!=null">
									<option value="${processTemplatesb.gongzhuangstatus}">
										${processTemplatesb.gongzhuangstatus}
									</option>
								</s:if>
								<option value="是">
									是
						...
						<td colspan="3">
							...
							<input type="text" id="shortname1" onkeyup="getAllNames1()"
								...
								value="${processTemplatesb.number}${processTemplatesb.matetag}" />
							<font style="color: red;">*根据名称模糊查工装</font>

							<!-- 12221333444444442333344555
							<select id="gongzhuang" name="processTemplatesbshebeiId"
								style="width: 155px;" onchange="ji(this.value);"></select>
								 -->
							<input id="gid" name="processTemplatesb.gzstoreId" type="hidden"
								value="${processTemplatesb.gzstoreId}" />
							<input id="number" name="processTemplatesb.number" type="hidden"
								value="${processTemplatesb.number}" />
							<input id="matetag" name="processTemplatesb.matetag" type="hidden"
								value="${processTemplatesb.matetag}" />
					...
					<tr>
						...
						<td>
							<select name="processTemplatesb.liangjustatus">
								<s:if test="processTemplatesb.gongzhuangstatus!=null">
									<option value="${processTemplatesb.liangjustatus}">
										${processTemplatesb.liangjustatus}
									</option>
								</s:if>
								<option value="是">
									是
						...
						<td colspan="3">
							...
							<input type="text" id="shortname" onkeyup="getAllNames()"
								...
								value="${processTemplatesb.measuringMatetag}${processTemplatesb.measuring_no}" />

							<font style="color: red;">*根据名称模糊查量具</font>
							<input id="measuringId" name="processTemplatesb.measuringId"
								type="hidden" value="${processTemplatesb.measuringId}" />
							<input id="measuringMatetag"
								name="processTemplatesb.measuringMatetag" type="hidden"
								value="${processTemplatesb.measuringMatetag}" />
							<input id="measuring_no" name="processTemplatesb.measuring_no"
								value="${processTemplatesb.measuring_no}" type="hidden" />
						</td>
					...
					<tr style="display: none">
						...
						<td align="left">
							<select name="processTemplatesb.operatorDept" id="dept"
								style="width: 100px; float: left;">
								<option value="${processTemplatesb.operatorDept}">
									${processTemplatesb.operatorDept}
								</option>
							</select>
						</td>
						<th align="right">
						...
						<td align="left">
							<input id="userId" name="processTemplatesb.operatorUserId"
								type="hidden" />
							<input id="userName" name="processTemplatesb.operatorName"
								value="${processTemplatesb.operatorName}" type="hidden" />
							<select id="users" style="width: 100px; float: left;">
								<option value="${processTemplatesb.operatorName}">
									${processTemplatesb.operatorName}
								</option>
							</select>
						</td>
						<th align="right">
						...
						<td>
							<input type="text" id="code" name="processTemplatesb.operatorCode"
								value="${processTemplatesb.operatorCode}" />
							<input id="cardId" name="processTemplatesb.operatorCardId"
								value="${processTemplatesb.operatorCardId}" type="hidden" />
						</td>
					</tr>
					<tr>
						<th align="right">
						...
						<td>
							<select name="processTemplatesb.shebeistatus">
								<s:if test="processTemplatesb.gongzhuangstatus!=null">
									<option value="${processTemplatesb.shebeistatus}">
										${processTemplatesb.shebeistatus}
									</option>
								</s:if>
								<option value="是">
									是
						...
						<td colspan="3">
							<select id="shebeiNo" name="processTemplatesb.shebeiNo"
								style="width: 200px;" onchange="getGongweiAndOth();">
								<s:if test="shebeiNo!=''">
									<option value="${processTemplatesb.shebeiNo}">
										${processTemplatesb.shebeiNo}${processTemplatesb.gongwei}${processTemplatesb.shebeiName}
									</option>
								</s:if>
								<option></option>
							</select>
					...
					<tr>
						...
						<td>
							<select name="processTemplatesb.gongwei" id="gongwei"
								style="width: 155px;">
								<!--  onchange="getshebeiCode(this)" -->
								<option value="${processTemplatesb.gongwei}">
									${processTemplatesb.gongwei}
								</option>
							</select>
						</td>
						<th align="right">
						...
						<td>
							<input type="text" name="processTemplatesb.shebeiName"
								id="shebeiName" readOnly="readonly"
								style="background-color: #cccccc;"
								value="${processTemplatesb.shebeiName}" />
						</td>
						<th>是否转存</th>
						<td><select name="processTemplatesb.needSave" class="yesOrNo" id="needSave">
							<option value="${processTemplatesb.needSave}">
									${processTemplatesb.needSave}
								</option>
								<option value="否">
									否
								</option>
					...
					<tr>
						...
						<td>
							<input type="text" name="processTemplatesb.opcaozuojiepai"
								value="${processTemplatesb.opcaozuojiepai}" />
							(s)
						</td>
						<th align="right">
							设备节拍:
						...
						<td>
							<input id="opshebeijiepai" type="text"
								name="processTemplatesb.opshebeijiepai"
								value="${processTemplatesb.opshebeijiepai}" />
							(s)
						</td>
						<th align="right">
							&nbsp;
					...
					<tr>
						...
						<td>
							<input type="text" name="processTemplatesb.opfuheRate"
								value="${processTemplatesb.opfuheRate}" />
						</td>
						<th align="right">
							技能指数:
						</th>
						<td>
							<input type="text" name="processTemplatesb.optechnologyRate"
								id="optechnologyRate" readOnly="readonly"
								style="background-color: #cccccc;"
								value="${processTemplatesb.optechnologyRate}" />
						</td>
						<th align="right">
							可替换人数:
						</th>
						<td>
							<input type="text" name="processTemplatesb.opCouldReplaceRate"
								id="opCouldReplaceRate" readOnly="readonly"
								style="background-color: #cccccc;"
								value="${processTemplatesb.opCouldReplaceRate}" />
						</td>
					...
					<tr>
						...
						<td>
							<input type="text" name="processTemplatesb.gzzhunbeijiepai"
								value="${processTemplatesb.gzzhunbeijiepai}" />
							(s)
						</td>
						<th align="right">
							准备次数:
						...
						<td>
							<input type="text" name="processTemplatesb.gzzhunbeicishu"
								value="${processTemplatesb.gzzhunbeicishu}" />
						</td>
						<th align="right">
							&nbsp;
						</th>
					...
					<tr>
						...
						<td>
							<input type="text" name="processTemplatesb.gzfuheRate"
								id="gzfuheRate" readOnly="readonly"
								style="background-color: #cccccc;"
								value="${processTemplatesb.gzfuheRate}" />
						</td>
						<th align="right">
							技能指数:
						</th>
						<td>
							<input type="text" name="processTemplatesb.gztechnologyRate"
								id="gztechnologyRate" readOnly="readonly"
								style="background-color: #cccccc;"
								value="${processTemplatesb.gztechnologyRate}" />
						</td>
						<th align="right">
							可替换人数:
						</th>
						<td>
							<input type="text" name="processTemplatesb.gzCouldReplaceRate"
								id="gzCouldReplaceRate" readOnly="readonly"
								style="background-color: #cccccc;"
								value="${processTemplatesb.gzCouldReplaceRate}" />
						</td>
					...
					<tr>
						...
						<td>
							<input name="processTemplatesb.deliveryDuration"
								value="${processTemplatesb.deliveryDuration}">
							(h)
						</td>
						<th>
							固定节拍
						...
						<td>
							<select name="processTemplatesb.guding">
								<option value="${processTemplatesb.guding}">
									${processTemplatesb.guding}
								</option>
								<option value="是">
									是
								</option>
					...
					<tr >
					 ...
					 <s:if test="processTemplatesb.isNeedFuliao=='yes'">
					  <input type="radio" name='processTemplatesb.isNeedFuliao'  value="yes" checked="checked" onchange="changeFuliao('是')">是
					  <input type="radio" name='processTemplatesb.isNeedFuliao'  value="no" onchange="changeFuliao('否')"> 否
					 </s:if>
					 <s:else>
					  <input type="radio" name='processTemplatesb.isNeedFuliao'  value="yes" onchange="changeFuliao('是')">是
					  <input type="radio" name='processTemplatesb.isNeedFuliao'  value="no" checked="checked" onchange="changeFuliao('否')"> 否
					 </s:else>
					 </td>
					</tr>
					<tr id="fuliaoTr">
					...
					<s:if test="processTemplatesb.isNeedFuliao=='yes'">
					 ...
					 <s:iterator value="processTemplatesb.processFuLiaoTemplate" id="pagefuliao" status="index">
					  <tr id='fuliaoTr<s:property value="#index.index"/>'>
					  <td style="border-top: 0px;border-left: 0px" align="center">
					  <input type="hidden" name="processTemplatesb.fuliaoList[<s:property value="#index.index"/>].id" value="<s:property value="#pagefuliao.id"/>">
					  <SELECT id="type<s:property value="#index.index"/>" name="processTemplatesb.fuliaoList[<s:property value="#index.index"/>].type">
					  ...
					  <td style="border-top: 0px;border-left: 0px" align="center">
							...
							<input type="text" id="shortnamefl<s:property value="#index.index"/>" onkeyup="getAllNamefls(<s:property value="#index.index"/>)"
								...
								onBlur="hidediv('showAllfl<s:property value="#index.index"/>')" name="processTemplatesb.fuliaoList[<s:property value="#index.index"/>].name" value="<s:property value="#pagefuliao.name"/>"/>
					  </td>
					  <td style="border-top: 0px;border-left: 0px" align="center"><input id="specification<s:property value="#index.index"/>" name="processTemplatesb.fuliaoList[<s:property value="#index.index"/>].specification" value="<s:property value="#pagefuliao.specification"/>"> </td>
					  
					  <td style="border-top: 0px;border-left: 0px" align="center"><input id="unit<s:property value="#index.index"/>" name="processTemplatesb.fuliaoList[<s:property value="#index.index"/>].unit" value="<s:property value="#pagefuliao.unit"/>"> </td>
					 
					  <td style="border-top: 0px;border-left: 0px" align="center"><input id="quanzhi1<s:property value="#index.index"/>" name="processTemplatesb.fuliaoList[<s:property value="#index.index"/>].quanzhi1" style="width: 80" value="<s:property value="#pagefuliao.quanzhi1"/>"> 
					  :<input id="quanzhi2<s:property value="#index.index"/>" name="processTemplatesb.fuliaoList[<s:property value="#index.index"/>].quanzhi2" style="width: 80" value="<s:property value="#pagefuliao.quanzhi2"/>"></td>
...
/* $(function(){
 var pid=document.getElementById("processTemplatesbid").value;
 //下拉工位编号
 $.ajax( {
 type : "POST",
 url : "ProcardTemplateAction!listgongzhuang.action",
 data: {processTemplatesb.id:pid},
 dataType : "json",
...
var fuliaoSize='<s:property value="processTemplatesb.processFuLiaoTemplate.size()"/>';
...
function addFuliaoLine(){
	...
	"<SELECT id='type"+maxFuLiaoIndex+"' name='processTemplatesb.fuliaoList["+maxFuLiaoIndex+"].type'><option>请选择</option><option >备件</option><option >金属五交材料</option><option>工具</option><option>办公用品</option><option>杂品</option><option>金属五交</option><option>工装</option><option>五金</option><option>包装物</option></SELECT> </td>"+
	          ...
	          "<input type='text' id='shortnamefl"+maxFuLiaoIndex+"' onkeyup='getAllNamefls("+maxFuLiaoIndex+")' style='height: 20px;' onFocus='init(\"shortnamefl"+maxFuLiaoIndex+"\",\"showAllfl"+maxFuLiaoIndex+"\","+maxFuLiaoIndex+")' onBlur='hidediv(\"showAllfl"+maxFuLiaoIndex+"\")' name='processTemplatesb.fuliaoList["+maxFuLiaoIndex+"].name' /> </td>"+
	          "<td style='border-top: 0px;border-left: 0px' align='center'><input id='specification"+maxFuLiaoIndex+"' name='processTemplatesb.fuliaoList["+maxFuLiaoIndex+"].specification'> </td>"+
	          "<td style='border-top: 0px;border-left: 0px' align='center'><input id='unit"+maxFuLiaoIndex+"' name='processTemplatesb.fuliaoList["+maxFuLiaoIndex+"].unit'> </td>"+
	          "<td style='border-top: 0px;border-left: 0px' align='center'><input id='quanzhi1"+maxFuLiaoIndex+"' name='processTemplatesb.fuliaoList["+maxFuLiaoIndex+"].quanzhi1' style='width: 80'>"+
	                   ":<input id='quanzhi2"+maxFuLiaoIndex+"' name='processTemplatesb.fuliaoList["+maxFuLiaoIndex+"].quanzhi2' style='width: 80'></td>"+
