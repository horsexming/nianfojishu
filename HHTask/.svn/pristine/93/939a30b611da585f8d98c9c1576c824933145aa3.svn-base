...
<html>
	...
	<div id="bodyDiv" align="center" class="transDiv"
		...
		<div id="gongneng"
			...
			<form action="oaReimBursementAction!updateStorageBZStatus.action" method="post">
			<center>
				<table class="table">
					<tr>
						<th>
					...
					<tr>
						<td colspan="12" align="center">
							<input type="button" value="全  选" onclick=" return check()">
							&nbsp;&nbsp;&nbsp;
							<input id="ok" class="input"  style="width:120px;" align="top" type="submit" value="批量通过" onclick="ExamIdea(this,this.form)"/>
    						<input id="ng" class="input" align="top" type="submit" value="批量驳回" onclick="ExamIdea(this,this.form)" />
	...
	function ExamIdea(obj,form){
		if(obj.id=="ok"){
    			form.action="oaReimBursementAction!updateStorageBZStatus.action?tag=ok";
    			form.submit();
    		}else if (obj.id=="ng"){
    			form.action="oaReimBursementAction!updateStorageBZStatus.action?tag=ng";
    			form.submit();
    		}
	}
	function bijia(obj) {
