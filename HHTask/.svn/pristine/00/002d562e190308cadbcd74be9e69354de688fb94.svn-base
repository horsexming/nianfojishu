	...
	<body>
			...
			<div id="closeDiv"
				...
				<div id="operatingDiv"
					...
					<form action="procardTemplateGyAction_closeSb.action" method="post">
						...
						备注:
						<textarea id="gbremark" name="type" rows="4" cols="40"></textarea>
		...
		<div id="gongneng" >
			...
			<div align="center">
				...
				<form action="procardTemplateGyAction_findSbApplyList.action"
					method="post">
...
<%--								<input type="button" value="导出1" style="width: 100px; height: 40px;" onclick="exprotBbAply(this.form)"/>--%>
								<input type="button" value="导出" style="width: 100px; height: 40px;" onclick="exprotBbAply_new(this.form);todisabledone(this)" data="downData"/>
							</td>
						</tr>
					</table>
				</form>
				<table width="100%" class="table">
					...
					<s:iterator value="bbAplyList" id="sbApply" status="pageStatus">
						...
						<td align="center">
							...
							<s:if test="#sbApply.processStatus=='取消'">
								<br/>
								(<font color="red">${sbApply.qxRemark}</font>)
							</s:if>
							</td>
						<td align="left">
							${sbApply.dqclUser}
