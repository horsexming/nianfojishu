		...
		<div id="gongneng"
			...
			<div id="xitong"
				...
				<div style="float: left; width: 45%; padding-top: 5px;"
					align="right">
					<a id="showHistory" href="javascript:;" onclick="chageCode()"
			...
			<div id="addContract" style="display: none">
				<form id="agreementForm"
					...
					<input type="hidden" name="contract.userId" id="userId"
						value="${user.id}">
					...
					<div style="width: 100%; padding: 20 0 20 0px">
						...
						<br />
						<font style="font-weight: bolder;" size="5px">岗位及薪资申请</font>
						<br />
						<br />
						<table align="left" border="2" class="table" id="contract">
							<tbody>
								...
								<tr>
									<td colspan="7">
										请输入工号:
										<input id="code" onkeyup="getUsers(this)" name="contract.code"
											value="${user.code}" />
									</td>
								</tr>
								<tr>
									...
									<td colspan="1">
										<input class="horizontalLine" name="contract.employedSquare"
											id="employedSquare" style="" value="${user.name}"
											readonly="readonly">
									</td>
									<th align="right">
										乙方部门:
									...
									<td colspan="1">
										<input class="horizontalLine" id="dept" readonly="readonly">
									</td>
								</tr>
								<tr>
									<th align="right">
									...
									<td>
										<input type="radio" name="contract.sqType" value="调整"
											checked="checked">
										调整
										<input type="radio" name="contract.sqType" value="新增">
										新增
										<font color="red">请注意选择您的类型(新入职人员务必选择新增)</font>
									</td>
									<th align="right">
										身份证号:
									</th>
									<td colspan="4">
										<input class="horizontalLine" name="contract.uid" id="uid"
								...
								<tr>
									...
									<td>
										<input class="horizontalLine" name="contract.sqyy" id="uid"
											style="width: 400px;">
									</td>
								</tr>
								<tr>
...
function chageCode() {
	...
	if (codeValue != "") {
		...
		location.href = "ContractAction!findUserWageAgre.action?contract.contractStatus=wage&contract.userId="
				+ userid;
	} else {
		alert("请输入工号!");
	}
