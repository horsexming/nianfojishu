	...
	<body>
		...
		<div id="gongneng"
			...
			<div align="center">
				...
				<form action="ProcardAction!findRootProcardListForww.action"
					method="post">
				...
				<table  class="table">
					...
					<s:iterator value="list" id="pageprocard" status="pageStatus">
						...
						<td colspan="2">
							...
							<input type="button" value="外协领料" style="height: 20px;width: 80px;" onclick="showProcardwwList(${pageprocard.id})">
						</td>
					</tr>
					</s:iterator>
					<tr>
...
function showProcardwwList(id){
	window.location.href="ProcardAction!showProcardwwList.action?id="+id;
}
