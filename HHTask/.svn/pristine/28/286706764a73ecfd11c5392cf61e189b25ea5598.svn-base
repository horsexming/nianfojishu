...
<script type="text/javascript"
		src="${pageContext.request.contextPath}/javascript/layer/layer.js"></script>
<style type="text/css">
...
.horizontalLine{
  ...
  <script type="text/javascript">
	...
	<body>
		...
		<form action="ReliabilityTestAction!addRTS.action" method="post" onsubmit="validate()" enctype="multipart/form-data">
			<table class="table">
				<tr align="center">
				...
				<tr>
					...
					<td><input type="text" name="sheet.number" value="${sheet.number}" readonly="readonly"></td>
					<th align="right">申请单位:</th>
					<td><input type="text" name="sheet.company" value="${Users.dept }"></td>
					<th align="right">申请日期:</th>
					<td><input type="text" name="sheet.addTime" value="${sheet.addTime }"></td>
					<th align="right">申请人:</th>
					<td><input type="text" name="sheet.addUserName" value="${Users.name }" readonly="readonly"></td>
				</tr>
				<tr>
					...
					<td colspan="3"><input type="text" name="sheet.specimenNum"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="7">
						<s:iterator value="proList" id="pro" >
							...
							name="recordList.proName" >${pro.proName }
						</s:iterator>
					</td>
				</tr>
				<tr>
			...
			<br/>
			 <table class="table">
				<thead>
					<tr>
						<th colspan="3" style="font-size: 20px;text-align: center;">测试记录</th>
					</tr>
					<tr>
							...
							<table class="table" style="padding: 0;margin: 0">
								<tr>
									...
									<td class="col-xs-3" style="margin: 0;padding: 0">
										<textarea style="width: 100%;margin: 0;padding: 0;resize:none;border:none"
											 name="sheet.jlPerson" placeholder="在这里输入记录人"></textarea>
									</td>
									<th class="col-xs-3">记录填写日期</th>
									<td class="col-xs-4" style="margin: 0;padding: 0">
										<textarea style="width: 100%;margin: 0;padding: 0;resize:none;border:none" 
											name="sheet.jlAddTime" placeholder="在这里输入填写日期"></textarea>
									</td>
								</tr>
							</table>
						</td>
...
<%--					<td class="col-xs-4" style="margin: 0;padding: 0">--%>
<%--						<textarea style="width: 100%;margin: 0;padding: 0;resize:none;border:none" name="sheet.decideBasis"></textarea>--%>
<%--					</td>--%>
<%--					<th class="col-xs-2">判定结果</th>--%>
<%--					<td class="col-xs-4" style="margin: 0;padding: 0">--%>
<%--						<textarea style="width: 100%;margin: 0;padding: 0;resize:none;border:none" name="sheet.decideResult"></textarea>--%>
<%--					</td>--%>
<%--				</tr>--%>
<%--				<tr>--%>
<%--					<th colspan="1" class="col-xs-2">记录/异常描述</th>--%>
<%--					<td colspan="3" class="col-xs-10" style="margin: 0;padding: 0">--%>
<%--						<textarea style="width: 100%;height: 70px;padding: 0;resize:none;border:none" name="sheet.errRemark"></textarea>--%>
<%--					</td>--%>
<%--				</tr>--%>
<%--			</table>--%>
			<div align="center">
				<input type="hidden" value="${dsId }" name="sheet.wdsId">
