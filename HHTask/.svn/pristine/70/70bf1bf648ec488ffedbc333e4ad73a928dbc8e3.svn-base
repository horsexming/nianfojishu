	...
	<body>
		...
		<div id="gongneng" style="width: 100%;">
			<div align="center">
				...
				<form action="procardTemplateGyAction_updateProcardTz.action"
								...
								<tr>
									...
									<td>
										<s:if test="tag==null||tag!='noxz'">
											<a
												href="procardTemplateGyAction_DownloadProcessTz.action?id=${spFile.id}">下载</a>
...
<%--													style="width: 80px; height: 80px;" /> --%>
									...
									<td>
										<s:if test="tag==null||tag!='noxz'">
											<a
												href="procardTemplateGyAction_DownloadProcessTz.action?id=${file3D.id}">下载</a>&nbsp;&nbsp;
...
<%--												style="width: 80px; height: 80px;" />--%>
									...
									<td>
										<s:if test="tag==null||tag!='noxz'">
											<a
												href="procardTemplateGyAction_DownloadProcessTz.action?id=${tzFile.id}">下载</a>&nbsp;&nbsp;
...
<%--												style="width: 80px; height: 80px;" /> --%>
									...
									<td>
										<s:if test="tag==null||tag!='noxz'">
											<a
												href="procardTemplateGyAction_DownloadProcessTz.action?id=${sopFile.id}">下载</a>&nbsp;&nbsp;
...
<%--												style="width: 80px; height: 80px;" /> --%>
									...
									<td>
										<s:if test="tag==null||tag!='noxz'">
											<a
												href="procardTemplateGyAction_DownloadProcessTz.action?id=${sapFile.id}">下载</a>&nbsp;&nbsp;
...
<%--												style="width: 80px; height: 80px;" /> --%>
									...
									<td>
										<%--										<a--%>
										<%--											href="procardTemplateGyAction_DownloadProcessTz.action?id=${modelFile.id}">下载</a>&nbsp;&nbsp;--%>
...
<%--												style="width: 80px; height: 80px;" /> --%>
									...
									<td>
										<s:if test="tag==null||tag!='noxz'">
											<a
												href="procardTemplateGyAction_DownloadProcessTz.action?id=${cxFile.id}">下载</a>&nbsp;&nbsp;
...
<%--												style="width: 80px; height: 80px;" /> --%>
									...
									<td>
										<s:if test="tag==null||tag!='noxz'">
											<a
												href="procardTemplateGyAction_DownloadProcessTz.action?id=${ncFile.id}">下载</a>&nbsp;&nbsp;
...
<%--												style="width: 80px; height: 80px;" /> --%>
									...
									<td>
										<s:if test="tag==null||tag!='noxz'">
											<a
												href="procardTemplateGyAction_DownloadProcessTz.action?id=${lsFile.id}">下载</a>&nbsp;&nbsp;
								...
								<tr>
									<td align="left">
										<a
											...
											<%--											href="<%=path%>/FileViewAction.action?FilePath=/upload/file/processTz/${bqwjFile.month}/<s:property value="#bqwjFile.fileName"/>">--%>
...
<%--												style="width: 80px; height: 80px;" /> --%>
									...
									<td>
										<a
											href="procardTemplateGyAction_DownloadProcessTz.action?id=${bqwjFile.id}">下载</a>&nbsp;&nbsp;
...
<%--												style="width: 80px; height: 80px;" /> --%>
									...
									<td>
										<a
											href="procardTemplateGyAction_DownloadProcessTz.action?id=${qtFile.id}">下载</a>&nbsp;&nbsp;
...
function deletetz(fileId, id) {
	if (window.confirm("确认要删除该条记录?")) {
		window.location.href = "ProcardTemplateAction!deleteProcessTz.action?processTemplateFile.id="
			...
			.uploadify(
					{
						...
						'uploader' : 'procardTemplateGyAction_updateProcardTz.action;jsessionid=<%=session.getId()%>',//请求路径  
						'auto' : false, //是否自动上传 
						'debug' : false,
						...
						'onUploadStart' : function(file) {
							...
							var ytRadioval = $(
									'input:radio[name="ytRadio"]:checked')
									.val();
