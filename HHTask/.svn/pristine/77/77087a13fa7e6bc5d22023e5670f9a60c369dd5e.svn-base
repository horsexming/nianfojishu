		...
		<div id="gongneng"
			...
			<div id="xitong"
				...
				<div style="float: left; width: 45%; padding-top: 5px;"
					align="right">
					<a href="processPRNScoreAction_toupdate.action" style="color: #ffffff">刷新<br />(reflesh)</a>
				</div>
			</div>
			...
			<div align="center">
				<h3>
					修改工序PRN评分
					<br />
					（update process PRN score）
				</h3>
				<form action="processPRNScoreAction_update.action" method="post"
					...
					<table class="table">
						<tr>
							...
							<td>
                                <input type="hidden" value="<s:property value="processPRNScore.id"/>" name="processPRNScore.id">
								  <SELECT name="processPRNScore.processName" id="pname">	
							        <option
										value="<s:property value="processPRNScore.processName"/>">
										<s:property value="processPRNScore.processName" />
									</option>					  
						...
						<tr>
							...
							<td>
								<input type="text" name="processPRNScore.content1" id="content1"
									value="<s:property value="processPRNScore.content1"/>"  />
							</td>
						</tr>
						<tr>
							<th align="right">
							...
							<td>
								<input type="text" name="processPRNScore.content2" id="content2"
									value="<s:property value="processPRNScore.content2"/>" />
							</td>
						</tr>
						<tr>
							<th align="right">
							...
							<td>
								<input type="text" name="processPRNScore.content3" id="content3"
									value="<s:property value="processPRNScore.content3"/>" />
							</td>
						</tr>
