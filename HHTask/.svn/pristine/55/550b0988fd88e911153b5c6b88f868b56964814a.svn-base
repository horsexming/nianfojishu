	...
	<body>
		...
		<div align="center" id="gongneng">
			<div align="center"
				...
				<form action="dimission_ZhengYiAction_add.action" method="post"
					onsubmit="return dimiss_ZYAdd()">
					<table class="table" align="center">
						<tr>
							<th align="center" colspan="8" style="size: 20pt;">
								添加离职工资单<input type="hidden" name="dimissionLog.id" value="${dimissionLog.id}" />
								<br/>
						...
						<tr>
							<th colspan="4" align="left" style="border-right-width: 0px;">
								&nbsp;&nbsp;&nbsp;&nbsp;离职申请单编号：${dimissionLog.shenqing_number}
								<input type="hidden" name="dimissionZhengYi.log_number"
									id="log_number" value="${dimissionLog.shenqing_number}" />
							</th>
							<th colspan="4" align="right" style="border-left-width: 0px;">
								...
								<input type="hidden" name="dimissionZhengYi.hand_number"
									id="hand_number" value="${dimissionHandover.dimission_number}" />
							</th>
						</tr>
						<tr>
							<td align="center">
							...
							<td align="center" style="width: 102px;">
								<input type="text" style="width: 100px;"
									name="dimissionZhengYi.name" id="name" value="${dimissionLog.name}"
									 />
								<input type="hidden"
									name="dimissionZhengYi.cardId" id="cardId" value="${dimissionLog.cardId}"
									 />
								<input type="hidden"
									name="dimissionZhengYi.dept" id="dept" value="${dimissionLog.dept}"
									 />
							</td>
							<td align="center">
								入职日期
							...
							<td align="center" colspan="2">
								<input type="text" name="dimissionZhengYi.ruzhiTime"
									id="ruzhiTime" value="${dimissionLog.ruzhi_time}">
							</td>
							<td align="center">
								离职日期
							</td>
							<td align="center" colspan="2">
								<input type="text" name="dimissionZhengYi.liTime" id="liTime"
									value="${dimissionLog.app_time}" readonly="readonly">
							</td>
						</tr>
						<tr>
							<td align="center">
							...
							<td align="center" style="width: 102px;">
								<input type="text" style="width: 100px;"
									name="dimissionZhengYi.code" id="code" value="${dimissionLog.code}"
									/>
							</td>
							<td align="center">
								离职原因
						...
						<tr>
							...
							<td align="center" colspan="2">
								<input class="Wdate" type="text"
									name="dimissionZhengYi.jxr_Time" id="jxr_Time" value=""
									onclick="WdatePicker({dateFmt:'yyyy-MM-dd',skin:'whyGreen'})">
							</td>
						</tr>
						<tr>
							...
							<td colspan="2">
								<input type="text" name="dimissionZhengYi.jx_Money"
									id="jx_Money" onblur="mustBeNumber('jx_Money')"/>
								元
							</td>
							<td align="center" colspan="2">
								应发岗位工资
							...
							<td colspan="2">
								<input type="text" name="dimissionZhengYi.gw_Money"
									id="gw_Money" onblur="mustBeNumber('gw_Money')"/>
								元
								<a href="dimission_ZhengYiAction_gzMuban.action?id=${dimissionLog.id}" target="_jixiao">工资模板查询</a>
							</td>
						</tr>
						<tr>
							<td align="center" colspan="2">
							...
							<td colspan="2">
								<input type="text" name="dimissionZhengYi.jiangj_Money"
									id="jiangj_Money" onblur="mustBeNumber('jiangj_Money')"/>
								元
							</td>
							<td align="center" colspan="2">
								餐费
							...
							<td colspan="2" align="left">
								<input type="text" name="dimissionZhengYi.canfei"
									id="canfei" onblur="mustBeNumber('canfei')"/>
								元 
						...
						<tr>
							...
							<td colspan="6">
								<input type="text" name="dimissionZhengYi.add_up_number"
									id="add_up_number" onblur="mustBeNumber('add_up_number')"/>
								元
							</td>
						</tr>
						...
						<tr>
							...
							<td align="center" style="width: 102px;">
								<input type="text" style="width: 100px"
									name="dimissionZhengYi.bc_Money" id="bc_Money" onblur="mustBeNumber('bc_Money')"/>
							</td>
							<td align="center">
								大写
							</td>
						...
						<tr>
							...
							<td colspan="2">
								<input type="text" name="dimissionZhengYi.butie" id="butie" onblur="mustBeNumber('butie')"/>
								元
							</td>
							<td align="center">
								补贴说明
						...
						<tr>
							...
							<td align="center" colspan="2">
								<input class="Wdate" type="text"
									name="dimissionZhengYi.sbjf_jzTime" id="sbjf_jzTime" value=""
									onclick="WdatePicker({dateFmt:'yyyy-MM-dd',skin:'whyGreen'})">
							</td>
							<td align="center" colspan="2">
								是否需要补足最低工资标准
						...
						<tr>
							...
							<td align="center" style="width: 98px;">
								<input type="text" style="width: 90px;"
									name="dimissionZhengYi.pension" id="pension" onblur="mustBeNumber('pension')"/>
							</td>
							<td align="center" style="width: 102px;">
								<input type="text" style="width: 100px;"
									name="dimissionZhengYi.yiliao" id="yiliao" onblur="mustBeNumber('yiliao')"/>
							</td>
							<td align="center">
								<input type="text" style="width: 90px;"
									name="dimissionZhengYi.shiye" id="shiye" onblur="mustBeNumber('shiye')"/>
							</td>
							<td align="center">
								<input type="text" style="width: 90px;"
									name="dimissionZhengYi.fund" id="fund" onblur="mustBeNumber('fund')"/>
							</td>
							<td align="center">
								<input type="text" style="width: 90px;"
									name="dimissionZhengYi.rent" id="rent" onblur="mustBeNumber('rent')"/>
							</td>
							<td align="center">
								<input type="text" style="width: 90px;"
									name="dimissionZhengYi.other" id="other" onblur="mustBeNumber('other')"/>
							</td>
							<td align="center" colspan="2">
								<input type="text" style="width: 98%;"
									name="dimissionZhengYi.real_money" id="real_money" onblur="mustBeNumber('real_money')"/>
							</td>
