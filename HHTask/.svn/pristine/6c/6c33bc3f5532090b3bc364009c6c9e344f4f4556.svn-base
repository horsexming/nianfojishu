...
<%--										<font color="red">合计<label id="allMoney"></label>元</font>--%>
	...
	<script type="text/javascript">
    	function chageType(obj,form){
    		if(obj.id=="ok"){
    			form.action="performsingleAction_updateContractExamList.action?tag=ok";
    			form.submit();
    		}else if (obj.id=="ng"){
    			form.action="performsingleAction_updateContractExamList.action?tag=ng";
    			form.submit();
    		}
    	}
