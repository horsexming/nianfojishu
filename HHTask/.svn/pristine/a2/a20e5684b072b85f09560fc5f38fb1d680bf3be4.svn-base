...
<html>
	...
	<body onload="loadValue();f1();">
		...
		<div id="gongneng"
			...
			<div align="center">
				<form action="LogoStickerAction!updateLogoSticker.action"
					onsubmit="return checkForm()" method="post">
					<h2>
						${companyInfo.name} 标识贴修改管理
					</h2>
					<input type="hidden" name="sticker.id" value="${sticker.id}">
					<input type="hidden" name="sticker.number"
						value="${sticker.number}">
					<input type="hidden" name="sticker.isPrint"
						value="${sticker.isPrint}">
					<table>
						<tr align="center">
							<td colspan="4" style="font-size: 20px;">
								标识类别：
								<select id="markSelect" style="font-size: 20px; width: 150px;"
									onchange="selectStickStyle(this)" name="sticker.stickStyle" >
									<option value="${sticker.stickStyle}">
										${sticker.stickStyle}
									</option>
									<option value="首检样品">
										首检样品
						...
						<tr>
							...
							<td>
								<input id="markId" type="text" name="sticker.markId"
									value="${sticker.markId}" />
							</td>
							<td align="center">
								工
								<span style="width: 7px;"></span>序
								<span style="width: 7px;"></span>号：
							</td>
							<td>
								<input id="processNO" type="text" name="sticker.processNO"
						...
						<tr>
							...
							<td>
								<input id="partsName" type="text" name="sticker.partsName"
									value="${sticker.partsName}" />
							</td>
							<td align="center">
								批
								<span style="width: 7px;"></span>次
								<span style="width: 7px;"></span>号：
							</td>
							<td>
								<input id="lotId" type="text" name="sticker.lotId"
									value="${sticker.lotId}" />
							</td>
						</tr>
						<tr>
							...
							<td>
								<input onMouseOut="getUserBy('co',this)" id="code" type="text"
									name="sticker.code" value="${sticker.code}" />
							</td>
							<td align="center">
								操
							...
							<td>
								<input id="operator" onMouseOut="getUserBy('na',this)"
									type="text" name="sticker.operator" value="${sticker.operator}" />
							</td>
						</tr>
						<tr>
							<td>
								签
								<span style="width: 14px;"></span>名：
							</td>
							<td>
								<input type="text" name="sticker.examinerName" />
							</td>
							<td align="center">
							...
							<td>
								<span style="display: none;" id="advise2"><input
										type="text" name="sticker.treatAdvice"
										value="${sticker.treatAdvice}" />
								</span>
								<span style="display: none;" id="advise3"><input
										type="text" name="sticker.count" value="${sticker.count}" />
								</span>
							</td>
						</tr>
						...
						<tr>
								...
								<div id="fp" style="text-align: center;">
									...
									<table>
										<tr>
											...
											<td colspan="2">
												<textarea id="demandExamContent"
													name="sticker.demandExamContent" cols="35" rows="6">${sticker.demandExamContent}</textarea>
											</td>
										</tr>
										<tr>
											<td colspan="2" align="left">
											...
											<td colspan="2">
												<textarea id="realExamContent"
													name="sticker.realExamContent" cols="35" rows="6">${sticker.realExamContent}</textarea>
											</td>
										</tr>
									</table>
								</div>
							...
							<td >
								...
								<select name="sticker.leixing" id="leixing" style="width: 100px;"   onchange="getyuanyin(this.value);">
    						<option value="${sticker.leixing}">${sticker.leixing}</option>
    						<option value="设备">设备</option>
                       		<option value="人员">人员</option>
							<option value="供应商">供应商</option>
				          </select></td>
				          <td>报废原因：</td>
				         <td> <select id="yuefen" style="width: 100px;" name="sticker.more"   >
				         <option value="${sticker.more}" >${sticker.more}</option>
				         </select>
							
							<!-- <textarea id="demandExamContent" name="sticker.more" cols="35" rows="6"></textarea> --></td></tr>
							<tr style="display:none;text-align:center;" id="t1"><td>责任人：</td><td><input type="text" name="sticker.gongyinshang" value="${sticker.gongyinshang}"/></td></tr>
						</table>	
								</div>
							</td>
						</tr>
						<tr><td >常用符号:</td><td>Φ ± ° ≤ ≥ ℃ < >  № ⊥  ◎     ○</td></tr>
						<tr>
							<td colspan="4" style="text-align: center">
								<input style="width: 80px; font-size: 18px;" type="submit"
									value="打印">
								<span style="width: 7px;"></span>
								<input style="width: 75px; font-size: 15px;" type="reset"
									value="取消">
							</td>
						</tr>
					</table>
