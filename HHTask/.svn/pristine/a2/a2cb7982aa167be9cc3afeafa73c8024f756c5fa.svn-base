			...
			<div align="center">
				<div id="xitong"
					...
					<div style="float: left; width: 45%; padding-top: 5px;"
						align="right">
						<a href="dimissionLogAction_showList_dai.action?tag=xieyi"
				...
				<div align="center">
					...
					<form action="dimissionLogAction_showList_dai.action?tag=xieyi" method="post">
					...
					<table  class="table">
						...
						<s:iterator value="dimissionLogList" id="dimisl"
							...
							<td colspan="2">
								...
								<s:if
									test="#dimisl.xieyi_status!=null&&#dimisl.xieyi_status=='待填写'">
									<a
										href="dimission_XieYiAction_toadd.action?dimissionLog.id=${dimisl.id}">/<font
										color="#ff0000">待添加离职协议</font>
									</a>
								</s:if>
							</td>
