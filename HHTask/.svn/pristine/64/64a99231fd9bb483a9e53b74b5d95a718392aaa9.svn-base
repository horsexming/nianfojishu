		...
		<div id="gongneng">
			...
			<div align="center">
				...
				<s:else>
					...
					<form action="systemFileAction_findAllnoshenpi.action"
						method="post">
				...
				<form id="piliangForm" method="post">
					<table width="100%" border="0" style="border-collapse: collapse;"
						...
						<s:iterator value="systemFileList" id="sFile" status="pageStatus1">
							...
							<td>
								<input type="checkbox" value="${sFile.id}" name="ids"/>
							</td>
							<td>
							...
							<td colspan="2">
								...
								<s:if test="#sFile.status=='未审批' || #sFile.status=='打回'">
...
function toSubmitTl1(form,tag){
	form.action = "systemFileAction_auditAllShenPi.action?tag="+tag;
	form.submit();
}
