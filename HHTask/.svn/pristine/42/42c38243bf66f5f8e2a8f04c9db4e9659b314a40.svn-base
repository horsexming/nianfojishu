...
<html>
	...
	<body>
		...
		<div id="gongneng" style="width: 100%;">
			...
			<div align="center">
				<form action="bonusShiZhiAction_linkProTryMake.action" method="post"
					 style="margin: 0px">
					<input type="hidden" name="bonusShiZhi.id" value="${bonusShiZhi.id}">
					<table style="width: 980px; border-collapse: collapse;" border="0"
						...
						<s:iterator id="hadPtm" value="hadPtmList"
							...
							<td>
								<input type="checkbox"
									name="checkboxs" value="${hadPtm.id}" onchange="chageNum()"
									checked="checked">
							</td>
							</tr>
							<s:if test="#ststusfunction.last">
								<tr bgcolor="green">
									<td colspan="7" style="font-family: 微软雅黑; font-weight: bold;"
										align="center">
										<font color="#ffffff"> 未绑定项目试制评审</font>
									</td>
								</tr>
							</s:if>
						</s:iterator>

						<s:iterator id="unhadPtm" value="unHadPtmList" status="ststusfunction">
							<s:if test="#ststusfunction.index%2==1">
								<tr align="center" bgcolor="#e6f3fb"
									onmouseover="chageBgcolor(this)"
									onmouseout="outBgcolor(this,'#e6f3fb')">
							...
							<td>
								<input type="checkbox"
									name="checkboxs" value="${unhadPtm.id}" onchange="chageNum()"/>
							</td>
							</tr>
						</s:iterator>
						<tr>
