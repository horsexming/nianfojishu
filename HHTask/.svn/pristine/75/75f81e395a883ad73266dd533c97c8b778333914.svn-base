...
<html>
	...
	<body>
		...
		<div id="gongneng" style="width: 100%;">
			<div align="center">
				<h3>重选外委</h3>
				<div align="left">原外委： 件号:${procard.markId},批次:{procard.selfCard},工序号:{wwApplyDetail.processNOs},工序名称:{wwApplyDetail.processNames},
				数量:${procard.wwCount}/${procard.unit},来源:手动外委,类型:{wwApplyDetail.wwType}</div>
			</div>
			<form action="procardTemplateGyAction_updateSbsdd.action" method="post">
