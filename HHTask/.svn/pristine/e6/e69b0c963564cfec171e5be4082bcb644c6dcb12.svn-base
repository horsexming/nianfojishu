	...
	<body>
		...
		<div id="gongneng" style="width: 100%; margin-top: 10px;">
			<div align="center">
				...
				<form action="ReceiptAction!findReceiptList.action" method="post">
				...
				<table class="table">
					...
					<s:iterator value="receiptList" id="pagecoreReceipt"
						...
						<td>
							<a
								href="ReceiptAction!findReceiptLogList.action?receiptLog.receipt.id=${pagecoreReceipt.id}">付款明细</a>
						</td>
					</s:iterator>
					<tr>
