	...
	<body>
		...
		<div id="gongneng">
			...
			<div align="center">
				...
				<form action="goodsAction!updateGoods.action?tag=dtc"
					...
					<table class="table" style="width: 95%;">
						...
						<tr>
							...
							<td>${goods.goodsClass}->
								<s:if test="goods.dtcFlag=='外协调委外'">
								<input id="warehouse" type="text" name="sell.sellWarehouse" value="委外库" readonly="readonly"/>
								</s:if>
								<s:else>
<%--								<input id="warehouse" type="text" name="sell.sellWarehouse"/>--%>
									<SELECT name="sell.sellWarehouse" id="warehouse" onchange="changvalue(this)">
										<option></option>
									</SELECT>
								</s:else>
							</td>
...
<%--								<input id="goodHouseName" type="text" name="sell.goodHouseName"/>--%>
...
<%--								<input type="text" name="goods.goodsPosition"/>--%>
						...
						<tr>
							...
							<td>
								<input id="sellCompanyPeople" type="text" name="sell.sellCompanyPeople" />
							</td>
							<th>
								领物品人
							</th>
