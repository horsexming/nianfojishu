...
<html>
	...
	<body>
		...
		<div id="gongneng"
			...
			<div align="center">
				<h3>审核流程</h3>
				<input type="button" value="添加审核流程" onclick="add()" style="width: 100px; height: 50px;"/>
		...
		<script type="text/javascript">
			function add(){
				window.location="/HHTas/System/caiwu/yewu/flow_add.jsp";
			}
			function update(id){
				window.location="business_initExamineFlow.action?id="+id;
			}
			function del(id){
				window.location="business_delExamineFlow.action?id="+id;
			}
		</script>
	</body>
</html>
