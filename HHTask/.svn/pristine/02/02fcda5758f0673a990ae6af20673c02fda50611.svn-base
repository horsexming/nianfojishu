    ...
    $.fn.freezeHeader = function (params) {
                ...
                obj.scroller.on('scroll', function () {
                    ...
                    if (obj.header.offset() != null) {
                        if (limiteAlcancado(obj, params)) {
                            ...
                            if (($( window.parent.document).scrollTop() > obj.header.offset().top)) {
                            	if( $("#workMainIframe",window.parent.document).attr('src') == undefined){
        ...
        function limiteAlcancado(obj, params) {
            if (params && params.height !== undefined) {
                ...
                return ($(window.parent.document).scrollTop() > obj.header.offset().top && $(window.parent.document).scrollTop() < (obj.grid.height() - obj.header.height() - obj.grid.find("tr:last").height()) + obj.header.offset().top);
            }
        }
        ...
        function cloneHeaderRow(obj) {
            ...
            if (params && params.height !== undefined) {
            	console.log('top',obj.scroller.offset().top)
