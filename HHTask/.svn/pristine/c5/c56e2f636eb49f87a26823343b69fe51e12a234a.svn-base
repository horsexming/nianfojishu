...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"><!-- 定额发票录入 -->
<html>
	<head>
		<style type="text/css">
.tr {
...
input:-ms-input-placeholder{  /* Internet Explorer 10-11 */ 
	...
	<body>
		...
		<div id="gongneng" style="width: 100%; margin-top: 10px;">
			...
			<div align="center">
				<h2>
<%--					<font size="5px;">定额发票录入</font><font size="4px;"><a href="FundApplyAction_toAddInvoce.action">增值税发票录入</a> </font>--%>
					...
					<input type="button" value="定额发票" style="background-color: gary; color: #000; width: 100px; height: 25px;">
				...
				<br/>
				<form action="FundApplyAction_addInvoceQuota.action" method="post"
					onsubmit="return validate()">
					<table>
						<tr><th colspan="4">定额发票录入</th></tr>
						<tr class="tr">
							<td align="right">
								发票代码：
								<input type="hidden" name="pagestatus" value="code"/>
								<input name="invoiceCheck.fpzlShow" placeholder="请输入发票类型" value="定额发票" type="hidden" />
							</td>
							<td align="left">
								<input name="invoiceCheck.fpdm" placeholder="请输入发票代码"
									class="ant-input ant-input-lg" id="fpdm" 
									onblur="//jianyanfpdm()" />
						...
						<tr class="tr">
							...
							<td align="left">
								<input name="invoiceCheck.fphm" placeholder="请输入8位发票号码"
									class="ant-input ant-input-lg"  id="fphm"
									onblur="jianyanfphm()" />
...
<!-- 									<font size="1px;">发票号码只能是8位的数字</font> -->
						...
						<tr class="tr">
							...
							<td align="left">
								<input name="invoiceCheck.kprq" placeholder="请选择开票日期"
						...
						<tr class="tr" id="je6">
							...
							<td align="left">
								<input name="invoiceCheck.jshj" placeholder="增值税专用发票，请输入税前金额"
...
<%--									<font size="1px;">专用发票，请输入税前金额</font>--%>
						...
						<tr class="tr">
							...
							<td align="left">
								<input name="invoiceCheck.xfmc" placeholder="请输入销售方信息"
						...
						<tr class="tr" style="display: none;" id="jym6">
							...
							<td align="left">
								<input name="invoiceCheck.jym" placeholder="其他发票，请输入校验码后6位"
