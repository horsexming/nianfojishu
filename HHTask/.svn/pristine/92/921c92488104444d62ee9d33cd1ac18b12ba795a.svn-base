			...
			<div align="center">
				...
				<div style="width: 100%;" align="center">
					...
					<font id="msgfont" color="red" size="5mm"></font>
						<form action="CheckoutAndGagesAction_addcag.action" method="POST" onsubmit="return check()">
							<table class="table">
								<tr>
									<th align="right">
										名&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称
									...
									<td>
										<input type="text" value="" name="cag.name" id="name">
									</td>
								</tr>
								<tr>
									<th align="right">
								...
								<tr>
									...
									<td>
										<input type="text" name="cag.codeLiable" value=""
								...
								<tr>
									...
									<td>
										<input type="text" name="cag.personLiable" value=""
								...
								<tr>
									...
									<td>
										<input type="text" name="cag.jyCycle" value="" id="jyCycle"
