...
<html>
	...
	<body>
		...
		<div id="gongneng" style="width: 100%;">
			<div align="center">
				<form action="JiaoXiaoKaoHeAction_updateTam.action" method="POST" onsubmit="return check()">
					<table class="table" style="width: 80%;">
						<tr>
							...
							<td>
								<input type="text" value="${tam.targetName}" name="tam.targetName" id="targetName"
						...
						<tr>
							...
							<td>
								<select name="tam.deptName" id="deptName">
									<option value="${tam.deptName}">${tam.deptName}</option>
								</select>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input type="text" value="${tam.marks}" name="tam.marks" id="marks"
								/>
							</td>
						</tr>
					</table>
					<input type="hidden" value="${tam.id}" name="tam.id"/>
