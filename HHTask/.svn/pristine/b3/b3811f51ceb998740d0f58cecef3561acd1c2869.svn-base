	...
	<body>
		...
		<div id="topDiv" align="center"
			...
			<div style="width: 980px;" align="right">
				<div style="font-size: 10px; padding-top: 5px;" align="right">
		...
		<iframe name="workMain" target="workMain" id="workMainIframe"
			src="${param.url!=null?param.url:'ModuleFunctionAction!findMfByUser.action'}"
...
function googleTranslateElementInit() {
	new google.translate.TranslateElement( {
		...
		<script
			src="http://www.translate.google.cn/translate_a/element.js?cb=googleTranslateElementInit">
</script>
		<!-- 天气 
		<script defer
