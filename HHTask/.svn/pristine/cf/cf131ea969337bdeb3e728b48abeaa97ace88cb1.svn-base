	...
	<body>
		...
		<div id="gongneng"
			...
			<div align="center">
				...
				<form
					action="oaAppDetailAction!findOADetail.action?powerTag=${powerTag}"
					method="post">
					<table class="table">
						<tr>
							<th>
								...
								<s:iterator value="list" status="se" id="detail">
									...
									<td>
										...
										<s:if
											...
											<a
												href="oaAppDetailAction!getOADetailById.action?id=${id}&tag=update&cpage=${cpage}">修改</a>
											<br />
