...
//				String contentType, HttpClientWrapper httpClientWrapper)
...
//					List<NameValuePair> nvBodyList = httpClientWrapper
//							.getNVBodies();
...
//				}
//
//				request.setConfig(httpClientWrapper.requestConfig);
//				request
...
//				httpClientWrapper.getResponseContent(entity, ret);
//				return ret;
//			} finally {
//				httpClientWrapper.close(entity, request, response);
//			}
//		}
//	}
//
...
//					.setCharset(Consts.UTF_8).setMessageConstraints(
...
//			IOException {
//		return VERBTYPE.GET.getResponse(url, "UTF-8", null, this);
//	}
//
//	/**
//	 * Get方式访问URL
...
//			throws HttpException, IOException {
//		return VERBTYPE.GET.getResponse(url, urlEncoding, null, this);
//	}
//
//	/**
//	 * POST方式发送名值对请求URL
...
//		return VERBTYPE.POST.getResponse(url, "UTF-8", null, this);
//	}
//
//	public ResponseContent postNV(String url, String contentType)
//			throws HttpException, IOException {
//		return VERBTYPE.POST.getResponse(url, "UTF-8", contentType, this);
//	}
//
//	public ResponseContent postNV(String url, String contentType,
//			String urlEncoding) throws HttpException, IOException {
//		return VERBTYPE.POST.getResponse(url, urlEncoding, contentType, this);
//	}
//
//	public ResponseContent postText(String url, String body,
//			String urlEncoding, String contentType) throws HttpException,
//			IOException {
//		return getTextResponse(url, body, urlEncoding, contentType);
//	}
//
//	public ResponseContent getTextResponse(String urlstr, String body,
//			String urlEncoding, String contentType) throws HttpException,
//			IOException {
//
//		if (urlstr == null)
...
//			// this.parseUrl(url);
//			HttpPost httpPost = new HttpPost(url);
//			httpPost.setEntity(new StringEntity(body, urlEncoding));
//			request = httpPost;
//			if (contentType != null) {
//				request.addHeader(HttpHeaders.CONTENT_TYPE, contentType);
//			}
...
//	}
//
//	public void getResponseContent(HttpEntity entity, ResponseContent ret)
//			throws IOException {
...
//				entityBuilder.addPart(nameValuePair.getName(), new StringBody(
//						nameValuePair.getValue(), ContentType.create(
//								"text/plain", urlEncoding)));
//			}
