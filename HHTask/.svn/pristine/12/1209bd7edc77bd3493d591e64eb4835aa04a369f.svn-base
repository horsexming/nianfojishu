	...
	<body>
		...
		<div id="gongneng"
			...
			<div align="center">
				...
				<form action="skillScoreAction_add.action" method="post"
					...
					<table class="table">
						<tr>
							...
							<td>
								<input type="text" name="skillScore.name" id="ssname" />
							</td>
						</tr>
						<tr>
							<th align="right">
							...
							<td>
								<input type="text" name="skillScore.score" id="ssscore" />
							</td>
						</tr>
						<tr>
							<th align="right">
							...
							<td>
								<input type="text" name="skillScore.totalscore" id="totalscore" />
							</td>
						</tr>
						<tr>
							<th align="right">
							...
							<td>
								<input type="text" name="skillScore.difficultScore" id="difficultScore" />
							</td>
						</tr>
