...
function checkLogin() {
	...
	if (code.value == "") {
		...
		document.getElementById("codeMessage").innerHTML = "<font color='#000000'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;* 员工号为三位数字组成</font>";
	}

	if (deptNumber.value == "") {
		document.getElementById("deptNumberMessage").innerHTML = "<font color='red'>&nbsp;&nbsp;&nbsp;&nbsp;* 部门编号不能为空</font>";
		deptNumber.focus();
		return false;
	} else {
		document.getElementById("deptNumberMessage").innerHTML = "<font color='#000000'>&nbsp;&nbsp;&nbsp;&nbsp;* 部门编号为字母组成</font>";
	}
						...
						<tr>
							...
							<td>
								<div id="codeMessage" style="width: 320px;">
									&nbsp;&nbsp;&nbsp;&nbsp;
									<font color="red">*</font>&nbsp;员工号为三位数字组成
								</div>
							</td>
						</tr>
						<tr>
