...
<html>
	...
	<body >
		<form action="paymentVoucherAction_updatePaymentVoucher.action" method="post">
			<table align="center" class="table">
				<tr>
					<th colspan="6">
						<font size="5">付款申请信息</font>
					</th>
				</tr>
				<tr>
						<th align="right">
						...
						<td>
							<input name="paymentVoucher.unitname" value="${paymentVoucher.unitname}" />
						</td>
					<!--					<set var="n" value="#parameters.test" />-->
						...
						<td>
							<input  name="paymentVoucher.relationclient" 	value="${paymentVoucher.relationclient}" />
						</td>
						<th align="right">
							评审编号:
						</th>
						<td>
							<input name="paymentVoucher.accreditationnum" value="${paymentVoucher.accreditationnum}" />
						</td>
				</tr>
				<tr>
						...
						<td>
							<input id="contractnum"  name="paymentVoucher.contractnum" 	value="${paymentVoucher.contractnum}" />
						</td>
						<th align="right">
						付款性质:
					</th>
...
<%--					<textarea id="paymentVoucher.voucherMoney" rows="10" cols="50" name="${paymentVoucher.voucherMoney}" ></textarea>--%>
					 ...
					 <SELECT name="paymentVoucher.voucherNature">
					 	<option value="${paymentVoucher.voucherNature}">${paymentVoucher.voucherNature}</option>
					 ...
					 <option value="${paymentVoucher.voucherway}">${paymentVoucher.voucherway}</option>
				...
				<th align="right">
					 ...
					 <option value="${paymentVoucher.vouchersituation}">${paymentVoucher.vouchersituation}</option>
					 ...
					 <option value="${paymentVoucher.vouchercondition}">${paymentVoucher.vouchercondition}</option>
...
<%--							<input name="paymentVoucher.category" value="${paymentVoucher.category}" />--%>
							...
							<option value="${paymentVoucher.category}">${paymentVoucher.category}</option>
