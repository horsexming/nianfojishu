	...
	<body onload="createDept('dept')">
		...
		<div id="gongneng" style="width: 100%;">
			<div align="center">
				<div>
					给
					<font color="red"> ${machine.omNum} </font>绑定灯
				</div>
				<div>
					<form action="OneMachineAction_findOneLightCondition.action"
					...
					<hr>
					<form action="OneMachineAction_bindingOneLight.action"
						method="post" style="margin: 0px">
						<input type="hidden" name="id" value="${id}">
						<table class="table" align="center">
							...
							<s:iterator id="lights" value="banglightList"
								...
								<td>
									<input type="checkbox"
										...
										name="lightId" value="${lights.id}" onclick="chageNum(this)"
										checked="checked">
								</td>
								</tr>
							...
							<s:iterator id="lights" value="lightList"
								status="ststusfunction">
								<s:if test="#ststusfunction.index%2==1">
									<tr align="center" bgcolor="#e6f3fb"
										onmouseover="chageBgcolor(this)"
