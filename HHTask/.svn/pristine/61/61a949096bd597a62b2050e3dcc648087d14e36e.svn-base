					...
					<form action="ProdEquipmentAction!printStorage.action"
						...
						<table width="100%" border="0" style="border-collapse: collapse;"
							...
							<s:iterator value="machineList" id="pagemachine"
								...
								<td align="center">
									<%--									<a--%>
									<%--										href="ProdEquipmentAction!checkMachiner.action?id=${pagemachine.id}">查看二维码/</a>--%>
									<%--${pagemachine.workPosition}--%>
									...
									<%--									<a href="ProdEquipmentAction!toaddbyr.action?id=${pagemachine.id}&cpage=${cpage}">添加保养记录</a>--%>
									<%--									/--%>
									<a
