				...
				<div id="submitProcessDiv" style="display: none;">
					...
					<div id="operatingDiv"
						...
						<form action="CwVouchersAction!shangchuan.action"
							...
							<input type="text" id="cwId" name="cwVouchers.id"/>
			...
			<div align="center">
				...
				<table class="table">
					...
					<s:iterator value="cwVouchersList" id="pageVouchers"
						status="pageStatus">
						<input type="hidden" class="cwId" name="cwVouchers.id" value="${pageVouchers.id}"/>
						...
						<td align="center">
							<a href="CwVouchersAction!showDetailList.action?id=${pageVouchers.id}">凭证明细</a>
							<a href="CwVouchersAction!updateShowDetailList.action?id=${pageVouchers.id}">修改凭证</a>
							<a href="javascript:void(0)" class="scpz">删除凭证</a>
							<%--							<a target="_vocher"--%>
...
/*$(".scpz").click(function(){
	...
	location.href="CwVouchersAction!deleteCwVouChers.action?cwVouChersId="+id;
})*/
