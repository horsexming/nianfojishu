...
<html>
	...
	<body>
		...
		<div id="gongneng"
			...
			<div align="center" id="d1">
				<form action="queXianAction!listQueXian.action" method="post"
					theme="simple">
					<table class="table">
						<tr>
							<th align="center">
							...
							<td>
								<input type="text" id="queXian.tianbaoren"
									name="queXian.tianbaoren" />
							</td>
							<th align="center">
								类型：
							</th>
							<td>
								<select name="queXian.leixing" id="queXian.leixing">
									<option value="">
										--请选择--
									</option>
									<option value="人">
				...
				<a href="<%=basePath%>/System/renshi/quexian/add_quexian.jsp">添加</a>
				<table class="table">
					<tr  bgcolor="#c0dcf2">
						<th>
							序号
					...
					<s:iterator value="list" id="zhUser1" status="pageIndex">
						<tr onmouseover="chageBgcolor(this)"
							...
							<th>
									...
									<a
										href="queXianAction!toUpdatequeXian.action?queXian.id=${zhUser1.id}">修改</a>|
									<a
										href="queXianAction!deletequeXian.action?queXian.id=${zhUser1.id}">删除</a>
											<s:if test='#zhUser1.tianbaoren==#session.Users.name'></s:if>
							</th>
						</tr>
					</s:iterator>
					<tr>
	...
	<SCRIPT type="text/javascript">
	 function f1(){
	    window.location.href="<%=basePath%>/System/renshi/quexian/add_quexian.jsp";
	}
	    // $(function (){
	    	// if(list.length==0){
