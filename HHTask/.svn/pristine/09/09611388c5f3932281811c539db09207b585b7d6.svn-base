...
<html>
	...
	<body>
		...
		<div id="gongneng" style="width: 100%;">
			...
			<div align="center">
				<form action="skillTypeAction_linkSkillScore.action" method="post"
					 style="margin: 0px">
					<input type="hidden" name="skillType.id" value="${skillType.id}">
					<table style="width: 980px; border-collapse: collapse;" border="0"
						...
						<s:iterator id="hadSScore" value="hadSScoreList"
							...
							<td>
								${hadSScore.totalscore}
							</td>
							<td>
								${hadSScore.difficultScore}
							</td>
							<td>
								${hadSScore.total}
							</td>
							<td>
								<input type="checkbox"
									name="checkboxs" value="${hadSScore.id}" onchange="chageNum()"
									checked="checked">
							</td>
							</tr>
						...
						<s:iterator id="unHadSScore" value="unHadSScoreList" status="ststusfunction">
							<s:if test="#ststusfunction.index%2==1">
								<tr align="center" bgcolor="#e6f3fb"
									onmouseover="chageBgcolor(this)"
									onmouseout="outBgcolor(this,'#e6f3fb')">
							...
							<td>
								${unHadSScore.totalscore}
							</td>
							<td>
								${unHadSScore.difficultScore}
							</td>
							<td>
								${unHadSScore.total}
							</td>
							<td>
								<input type="checkbox"
									name="checkboxs" value="${unHadSScore.id}" onchange="chageNum()"/>
							</td>
							</tr>
						</s:iterator>
						<tr>
