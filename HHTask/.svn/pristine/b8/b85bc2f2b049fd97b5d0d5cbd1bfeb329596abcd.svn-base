...
public interface WaigouWaiweiPlanServer {
	 ...
	 * @return
	 */
	String addWgOrder(Integer[] procardIds,String pageStatus);
	...
	Object[] findWwPlanList(WaigouPlan waigouPlan, int parseInt, int pageSize,
			String pageStatus, String startDate, String endDate, Integer id,String sunxu);
	 ...
	 * @return
	 */
	Map<Integer, Object> addDeliveryNote(WaigouDelivery waigouDelivery,
			List list);
	...
	/****
	 * 分页，查询所有的待确认的送货单 根据送货单号查询所有订单
	 * 
	 * @return
	 */
	Object[] findDqrDelivery(String pageStatus, WaigouDelivery waigouDelivery,
	 ...
	 * @return
	 */
	Object[] findDjyDelivery(WaigouDeliveryDetail waigoudd, String pageStatus,
	...
	String updateStick2(OsRecord osRecord, List<OsRecord> osRecordList,
			String status, Float jyNumber, Float buhegeNumber,
	 ...
	 * @return
	 */
	String sdaddwaigouOrder(Integer[] procardId, Integer priceId,
			Float[] caigouNum);
	...
	Map<Integer, Object> findAllqualifiedRate(QualifiedRate qualifiedRate,
			int pageNo, int pageSize);
	 ...
	 * @return
	 */
	Object[] findWwRukuDailingList2(WaigouDeliveryDetail waigoudd,
	 ...
	 * 
	 */
	WgProcardMOQ findWgMOQOne(Integer rootId, String markId, String kgliao,
			String specification, String banBenNumber);
	...
	String ajax_addremark(Integer rootId, String markId, String kgliao,
	 ...
	 * 导出退货明细
	 */
	void exprotrds(ReturnsDetails rds, String status, String startDate,
	 ...
	 * 采购单，送货单。对账
	 */
	List WaigouPlanduiZhang(String type, String months0, String months1,
	 ...
	 * @return
	 */
	Map<String, Object> findmarkIdTime(String markid, String startTime,
			String endTime);
	 ...
	 * @return
	 */
	Map<String, Object> findcaigouAllTime();
	
	String	delwaigouDelivery(Integer id);
	/**
	 * 查看mop图纸
	 * @param id
	 * @return
	 ...
	 * 查询所有供应商件号送货关闭情况
	 */
	Object[] findAllGysMarkIdCkolse(GysMarkIdCkolse gysClose,Integer pageSize,Integer pageNo,String status);
	
	/**
	 * 
	 */
	String	updateGysMarkIdCkolse(GysMarkIdCkolse gysClose);
	/**
	 * 手动解锁外委明细
	 * @param id
	 * @return
	 */
	String sdjs(Integer id);
	/**
	 * 拆分waigouwaiweiPlan
	 * @param id
	 * @param splitCount1
	 ...
	 * @return
	 */
	String splitwwpCount(Integer id, int splitCount1, int splitCount2);
