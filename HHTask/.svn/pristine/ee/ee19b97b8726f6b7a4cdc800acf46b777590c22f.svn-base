...
public class VOStorage implements java.io.Serializable {
	...
	private Integer oaDetailId;
	
	
	private String more; 
	private Float storageTaxPrice; 
	private String storageInvoice;
	private String storageCompany;
	private String storageIsTax;
	private Float storageTaxRate; 
	...
	public String getApplyForNum() {
		return applyForNum;
	}
	public void setApplyForNum(String applyForNum) {
