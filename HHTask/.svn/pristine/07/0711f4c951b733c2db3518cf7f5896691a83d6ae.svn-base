		...
		<div id="gongneng"
			...
			<div id="xitong"
				...
				<div style="float: left; width: 45%; padding-top: 5px;"
					align="right">
					<a style="color: white;" target="_blank" href="fanghuYongpinAction!getFanghuYongpinQuanxianAddPage.action">添加用户权限</a>
				</div>
			</div>
			...
			<div align="center">
				<table class="table" style="text-align: center;">
					...
					<s:iterator id="f" value="fanghuYongpinQuanxianList" status="st">
						...
						<tr align="center" onmouseover="chageBgcolor(this);" onmouseout="outBgcolor(this,'');">
							...
							<td>${st.index + 1}</td>
							<td>${lingquUser.name}</td>
							<td>${lingquUser.code}</td>
							<td>${lingquUser.cardId}</td>
							<td>${lingquUser.dept}</td>
							<td>
