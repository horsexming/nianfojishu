		...
		<div id="gongneng"
			...
			<div align="center">
				...
				<table style="width: 980px; border-collapse: collapse;font-size: 12px" border="0"
					...
					<s:iterator id="overtime" value="overtimeListForRsForDqr" status="ststusOvertime">
					...
					<s:iterator id="overtime" value="overtimeListForRsForYqr" status="ststusOvertime">
						<s:if test="#ststusOvertime.first">
							<tr bgcolor="green">
								<th colspan="11" align="center">
									<font color="#ffffff"> 已确认加班记录</font>
								</th>
							</tr>
						</s:if>
						<s:if test="#ststusOvertime.index%2==1">
						...
						<td>
							<s:if test="#overtime.epId!=null">
								<a href="CircuitRunAction_findAduitPage.action?id=${overtime.epId}">审批动态</a>
							</s:if>
						</td>
						</tr>
					</s:iterator>
