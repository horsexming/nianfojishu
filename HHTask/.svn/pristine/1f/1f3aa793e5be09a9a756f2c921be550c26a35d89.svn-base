				...
				<table class="table">
					...
					<s:iterator value="list" id="zhaobiao1" status="pageIndex">
						<tr onmouseover="chageBgcolor(this)"
							...
							<th>${zhaobiao1.title}</th>
							<th>${zhaobiao1.fuze}</th>
							<th>${zhaobiao1.phone}</th>
							
							<th>${zhaobiao1.moban}</th>
							<th>${zhaobiao1.kongxian}</th>
							<th>
							     <a href="zhaobiaoAction!zhaobiaoXilist.action?zhaobiao.id=${zhaobiao1.id}">成本核算</a> 
							</th>
						</tr>
					</s:iterator>
					<tr>
