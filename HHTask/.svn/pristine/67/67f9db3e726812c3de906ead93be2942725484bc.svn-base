...
<html>
	...
	<body>
		...
		<div id="gongneng"
			...
			<div align="center" id="d1">
			  ...
			  <table class="table">
			  <tr><th colspan="10" align="center">外购外协件验收频次规定子项</th></tr>
				...
				<table class="table">
					...
					<s:iterator value="list" id="zhUser1" status="pageIndex">
						<tr align="center" bgcolor="#e6f3fb"
							...
							<th>${zhUser1.caigoushuliang1} ~ ${zhUser1.caigoushuliang2}    </th>
							<th>${zhUser1.choujian}</th>
	...
	<SCRIPT type="text/javascript">
			...
			var url=encodeURI(encodeURI("markIdAction!toaddwaigoujianpinci.action?waigoujianpinci.id="+${waigoujianpinci.id}));
			$("#showProcess").attr("src", url);	
		   chageDiv('block');
	}
		function toUpdatezhaobiao(id){
			var url=encodeURI(encodeURI("markIdAction!toUpdatewaigoujianpinciZi.action?waigoujianpinciZi.id="+id));
		$("#showProcess").attr("src", url);	
		chageDiv('block');
	}
	</SCRIPT>
