package com.task.util.licensecreate;
...
public class CreateLicense {
	...
	public void setParam(String licPath,String issuedTime,String notAfter,String info) {
		// 获取参数
		Properties prop = new Properties();
		InputStream in = getClass().getResourceAsStream("param.properties");
		try {
			prop.load(in);
		} catch (IOException e) {
		...
		notBefore = DateUtil.formatDate(new Date(), "yyyy-MM-dd");
