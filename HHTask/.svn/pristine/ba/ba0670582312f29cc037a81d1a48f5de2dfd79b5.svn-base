...
<html>
	...
	<body>
		...
		<div id="gongneng"
			...
			<div align="center">
				<form action="mealAction!update.action?mealticket.id=${mealticket.id}" method="post"
					onsubmit="return fuck()">
					<table class="table">
						<tr>
							<th colspan="4">
								客饭票
						...
						<tr>
							...
							<td align="left">
								<div style="float: left;">
									<input type="text" name="mealticket.name" value="${mealticket.name}" id="name"
										onblur="nameCheck()">
								</div>
							...
							<td align="left">
								<input type="text" name="mealticket.job" value="${mealticket.job}"  id="job" onblur="jobCheck()"> <span id="rejob"></span>
							</td>
						</tr>
						<tr>
							<th align="right">
							...
							<td align="left">
								<input type="text" name="mealticket.company"" value="${mealticket.company}" id="company" onblur="companyCheck()"> <span id="recompany"></span>
							</td>
							<th align="right">
								人数：
							</th>
							<td align="left">
								<div style="float: left;width=90pxs">
									...
									onblur="numberCheck()" value="${mealticket.number}" >
								</div>
						...
						<tr>
							...
							<td align="left">
								<input type="text" name="mealticket.reason" value="${mealticket.reason}"  id="reason" onblur="reasonCheck()"> <span id="rereason"></span>
							</td>
							<th align="right">
								有效日期：
							</th>
							<td align="left">
								<input type="text" name="mealticket.intime" value="${mealticket.intime}"  id="manage" onblur="manageCheck()" class="Wdate"
