	...
	<body>
		...
		<div id="gongneng" style="width: 100%; margin-top: 10px;">
			<div align="center">
				...
				<form action="DanganAction_addCw.action" method="post"
...
function addDangan(obj, few) {
	...
	$("#tablebod>tbody>tr")
			...
			.after(
					"<tr id='addtr"
							+ index
							+ "'><th colspan='1' align='center'>存档类型： </th><td colspan='1' align='center'><select name='archiveUnarchiverApltList["
							+ index
							+ "].cqType' id="
							+ cqType
							+ "><option value=''>请选择存取档类型</option><option value = '存档'>存档</option><option value = '取档'>取档</option></select></td><th >档案名称</th><td align='center'><input type='text' title='点击选择档案' readonly='readonly' onclick='selectcwPrice("
							+ index
							+ ")' name='archiveUnarchiverApltList["
							+ index
							+ "].daName' id="
							+ daName
							+ "></td><th >档案编号</th><td align = 'center'><input type='text' title='点击选择档案' onclick='selectcwPrice("
							+ index
							+ ")' readonly='readonly' name='archiveUnarchiverApltList["
							+ index
							+ "].daNum' id="
							+ daNum
							+ "></td><th align = 'center'>位置： </th><td align = 'center'><input type='text' title='点击选择档案' onclick='selectcwPrice("
							+ index
							+ ")' readonly='readonly' name='archiveUnarchiverApltList["
							+ index
							+ "].daGuihao' id="
...
function selectcwPrice(num) {
	...
	var url = "CwCertificateAction_showList.action?tag=cw&num_1="+num;
