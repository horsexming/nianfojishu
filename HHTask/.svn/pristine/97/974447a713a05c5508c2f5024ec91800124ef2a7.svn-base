...
$(document).ready(function() {
	...
	<body style="height: 4500px;">
		<div align="center">
			<form action="NoncorePayableAction!userBangpyType.action" method="post"
			...
			<form action="NoncorePayableAction!linkUserProcess.action" method="post"
					...
					<s:iterator id="had" value="yiBList" status="ststusfunction">
						...
						<s:if test="#ststusfunction.last">
							<tr bgcolor="green">
								<td colspan="7" style="font-family: 微软雅黑; font-weight: bold;"
									align="center">
									<font color="#ffffff"> 未绑定类型</font>
								</td>
							</tr>
						</s:if>
					</s:iterator>

					<s:iterator id="unHad" value="weiBList" status="ststusfunction">
						<s:if test="#ststusfunction.index%2==1">
							<tr align="center" bgcolor="#e6f3fb"
								onmouseover="chageBgcolor(this)"
								onmouseout="outBgcolor(this,'#e6f3fb')">
