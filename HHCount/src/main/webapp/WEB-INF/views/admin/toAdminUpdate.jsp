	    ...
	    <div class="line head clearfix ">
	    	<div class="head-mu xb8 xm10 xs12 xl12">
	        	...
	        	<ul class="head-list list-inline xb6 xm6 xs6 xl12">
	            	<li><a href="<%=request.getContextPath()%>/Admin/toAdminIndex">返回首页</a></li>	        
	    ...
	    <div class="index-body xb8 xm12 xs12 xl12">
	        <div class="line index-body-nr-left clearfix">
	            <div class="main-tit xl12 xs12 xm12 xb12">
	                ...
	                <p><br>                	          
	              	<form action="<%=request.getContextPath()%>/Admin/Update" method="post" id="userform" class="form-horizontal">
						...
						<div class="form-group">
						    ...
						    <div class="col-sm-6">
								<input type="text" name="username" class="form-control" id="username3" value="${updateAdmin.username}">
						...
						<div class="form-group">
						    ...
						    <div class="col-sm-6">
								<input type="text" name="password" class="form-control" id="password3" value="${updateAdmin.password}">
						 ...
						 <div class="form-group">
						    ...
						    <div class="col-sm-6">
								<input type="text" name="phone" class="form-control" id="phone3" value="${updateAdmin.phone}" onkeyup="value=value.replace(/[^\d]/g,'')">
						 ...
						 <div class="form-group">
						    ...
						    <div class="col-sm-6">
								<input type="text" name="realname" class="form-control" id="realname3" value="${updateAdmin.realname}">
					      	</div>
						 </div>
						  <div class="form-group">
						    ...
						    <div class="col-sm-6">
						    	<div class="radio">
									<label class="radio-inline">
					  					<input type="radio" name="sex" id="sex1" value="m" <c:if test="${updateAdmin.sex=='m'}">checked</c:if>> 男
									</label>
									<label class="radio-inline">
									&nbsp;
									</label>
									<label class="radio-inline">
					  					<input type="radio" name="sex" id="sex2" value="n" <c:if test="${updateAdmin.sex =='n'}">checked</c:if>> 女
									</label>
								</div>					      	
							</div>
						 </div>
						 <div class="form-group">
						    ...
						    <div class="col-sm-6">
								<input type="text" name="age" class="form-control" id="age3" value="${updateAdmin.age}" onkeyup="value=value.replace(/[^\d]/g,'')">
					      	</div>
						 </div>
					</form>	               
	            </div>
