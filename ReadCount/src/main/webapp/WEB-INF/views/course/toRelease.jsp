                    ...
                    <div class="col-md-6">
                        <div class="card p-4">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <span>课程名：</span>
                                    <span><input type="text" name="coursename" id="coursename" style=" width:300px;"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card p-4">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <span>每日阅读量参考：</span>
                                    <span><input type="text" name="courseRead" onkeyup="value=value.replace(/[^\d]/g,'')" style= "width:300px;"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-0">      
                                <div class="justify-content-around mt-4 p-4 bg-light d-flex border-top d-md-down-none">
                                	<textarea rows="17" cols="170" name="coursetext"></textarea>	
                                </div>
                                <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
