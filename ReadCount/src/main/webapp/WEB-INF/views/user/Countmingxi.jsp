                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <font size="4">阅读明细</font>
                                <c:if test="${co=='Day'}">
	                                <a href="<%=request.getContextPath()%>/User/ReadCount?pn=${pg}">
		                				<font color="#6CA6CD">&nbsp;&nbsp;返回统计&nbsp;</font>
		                			</a>
                                </c:if>
                                <c:if test="${co=='Year'}">
	                                <a href="<%=request.getContextPath()%>/User/ReadCountByY">
		                				<font color="#6CA6CD">&nbsp;&nbsp;返回统计&nbsp;</font>
		                			</a>
                                </c:if>
                                <c:if test="${co=='Month'}">
	                                <a href="<%=request.getContextPath()%>/User/ReadCountByM">
		                				<font color="#6CA6CD">&nbsp;&nbsp;返回统计&nbsp;</font>
		                			</a>
                                </c:if>     
                            </div>
