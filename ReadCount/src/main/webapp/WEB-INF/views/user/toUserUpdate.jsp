                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-0">      
                                <div class="justify-content-around mt-4 p-4 bg-light d-flex border-top d-md-down-none">
                                	<form action="<%=request.getContextPath()%>/User/Update" method="post" id="userform">
										<table align="center" class="table table-hover">
											<input name="id" value="${updateUser.id}" type="hidden">
				  							<input name="role" value="${updateUser.role}" type="hidden">
											<tr>
												<td>用户名:</td>
												<td><input type="text" name="username" class="form-control" id="username3" value="${updateUser.username}"></td>
												<td><font color="red"><span id="tip"></span></font></td>
												<td><input type="hidden" value="" class="form-control" id="tip2"></td>
											</tr>
											<tr>
												<td>密码:</td>
												<td><input type="text" name="password" class="form-control" id="password3" value="${updateUser.password}"></td>
												<td><font color="red"><span id="tip1"></span></font></td>
											</tr>
											<tr>
												<td>手机号:</td>
												<td><input type="text" name="phone" class="form-control" id="phone3" value="${updateUser.phone}" onkeyup="value=value.replace(/[^\d]/g,'')"></td>
											...
											<tr>
												<td>真实姓名:</td>
												<td><input type="text" name="realname" class="form-control" id="realname3" value="${updateUser.realname}"></td>
											</tr>
											<tr>
												<td>性别:</td>
												<td><input type="radio" name="sex" id="sex1" value="m" <c:if test="${updateUser.sex=='m'}">checked</c:if>> 男
												<input type="radio" name="sex" id="sex2" value="n" <c:if test="${updateUser.sex =='n'}">checked</c:if>> 女</td>
											</tr>
											<tr>
												<td>年龄:</td>
												<td><input type="text" name="age" class="form-control" id="age3" value="${updateUser.age}" onkeyup="value=value.replace(/[^\d]/g,'')"></td>
											</tr>
										</table>
									</form>
                                </div>
